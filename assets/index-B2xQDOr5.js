...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wo(e,t,n){let r=new Float32Array(lo),i=new G(0,1,0);return new Bi({name:`SphericalGaussianBlur`,defines:{n:lo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Do(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function To(){return new Bi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Do(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(){return new Bi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Do(),fragmentShader:`
	...
	`}var Oo=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Ci([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var $s={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ec(e,t){let n=$s[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var tc=new G;function nc(){return qt.getLuminanceCoefficients(tc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${tc.x.toFixed(4)}, ${tc.y.toFixed(4)}, ${tc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
}`,nl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new q(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Bi({vertexShader:el,fragmentShader:tl,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new di(new ki(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},rl=class extends jt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,m=typeof XRWebGLBinding<`u`,h=new nl,g={},_=t.getContextAttributes(),v=null,y=null,b=[],x=[],S=new W,C=null,w=new ba;w.viewport=new an;let T=new ba;T.viewport=new an;let E=[w,T],D=new ja,O=null,ee=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=b[e];return t===void 0&&(t=new Bn,b[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=b[e];return t===void 0&&(t=new Bn,b[e]=t),t.getGripSpace()},this.getHand=function(e){let t=b[e];return t===void 0&&(t=new Bn,b[e]=t),t.getHandSpace()};function k(e){let t=x.indexOf(e.inputSource);if(t===-1)return;let n=b[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function A(){r.removeEventListener(`select`,k),r.removeEventListener(`selectstart`,k),r.removeEventListener(`selectend`,k),r.removeEventListener(`squeeze`,k),r.removeEventListener(`squeezestart`,k),r.removeEventListener(`squeezeend`,k),r.removeEventListener(`end`,A),r.removeEventListener(`inputsourceschange`,j);for(let e=0;e<b.length;e++){let t=x[e];t!==null&&(x[e]=null,b[e].disconnect(t))}O=null,ee=null,h.reset();for(let e in g)delete g[e];e.setRenderTarget(v),f=null,d=null,u=null,r=null,y=null,re.stop(),n.isPresenting=!1,e.setPixelRatio(C),e.setSize(S.width,S.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&V(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&m&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(v=e.getRenderTarget(),r.addEventListener(`select`,k),r.addEventListener(`selectstart`,k),r.addEventListener(`selectend`,k),r.addEventListener(`squeeze`,k),r.addEventListener(`squeezestart`,k),r.addEventListener(`squeezeend`,k),r.addEventListener(`end`,A),r.addEventListener(`inputsourceschange`,j),_.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(S),m&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;_.depth&&(o=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=_.stencil?be:ye,a=_.stencil?pe:ce);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new sn(d.textureWidth,d.textureHeight,{format:ve,type:ie,depthTexture:new Ti(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),y=new sn(f.framebufferWidth,f.framebufferHeight,{format:ve,type:ie,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),re.setContext(r),re.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return h.getDepthTexture()};function j(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=x.indexOf(n);r>=0&&(x[r]=null,b[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=x.indexOf(n);if(r===-1){for(let e=0;e<b.length;e++)if(e>=x.length){x.push(n),r=e;break}else if(x[e]===null){x[e]=n,r=e;break}if(r===-1)break}let i=b[r];i&&i.connect(n)}}let M=new G,te=new G;function N(e,t,n){M.setFromMatrixPosition(t.matrixWorld),te.setFromMatrixPosition(n.matrixWorld);let r=M.distanceTo(te),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function P(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;h.texture!==null&&(h.depthNear>0&&(t=h.depthNear),h.depthFar>0&&(n=h.depthFar)),D.near=T.near=w.near=t,D.far=T.far=w.far=n,(O!==D.near||ee!==D.far)&&(r.updateRenderState({depthNear:D.near,depthFar:D.far}),O=D.near,ee=D.far),D.layers.mask=e.layers.mask|6,w.layers.mask=D.layers.mask&-5,T.layers.mask=D.layers.mask&-3;let i=e.parent,a=D.cameras;P(D,i);for(let e=0;e<a.length;e++)P(a[e],i);a.length===2?N(D,w,T):D.projectionMatrix.copy(w.projectionMatrix),F(e,D,i)};function F(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=Pt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(!(d===null&&f===null))return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return h.texture!==null},this.getDepthSensingMesh=function(){return h.getMesh(D)},this.getCameraTexture=function(e){return g[e]};let I=null;function ne(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(y,f.framebuffer),e.setRenderTarget(y));let i=!1;t.length!==D.cameras.length&&(D.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(y,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(y))}let o=E[n];o===void 0&&(o=new ba,o.layers.enable(n),o.viewport=new an,E[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(D.matrix.copy(o.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),i===!0&&D.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&m){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&h.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&m){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=g[n];e||(e=new q,g[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<b.length;e++){let t=x[e],n=b[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}I&&I(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let re=new Za;re.setAnimationLoop(ne),this.setAnimationLoop=function(e){I=e},this.dispose=function(){}}},il=new bn,al=new un;function ol(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ii(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,il.copy(o),il.x*=-1,il.y*=-1,il.z*=-1,a.isCubeTexture&&a.isRenderTargetTexture===!1&&(il.y*=-1,il.z*=-1),e.envMapRotation.value.setFromMatrix4(al.makeRotationFromEuler(il)),e.flipEnvMap.value=a.isCubeTexture&&a.isRenderTargetTexture===!1?-1:1,e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function sl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(m(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,g));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return H(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let t=0,n=r.length;t<n;t++){let n=Array.isArray(r[t])?r[t]:[r[t]];for(let r=0,i=n.length;r<i;r++){let i=n[r];if(p(i,t,r,a)===!0){let t=i.__offset,n=Array.isArray(i.value)?i.value:[i.value],r=0;for(let a=0;a<n.length;a++){let o=n[a],s=h(o);typeof o==`number`||typeof o==`boolean`?(i.__data[0]=o,e.bufferSubData(e.UNIFORM_BUFFER,t+r,i.__data)):o.isMatrix3?(i.__data[0]=o.elements[0],i.__data[1]=o.elements[1],i.__data[2]=o.elements[2],i.__data[3]=0,i.__data[4]=o.elements[3],i.__data[5]=o.elements[4],i.__data[6]=o.elements[5],i.__data[7]=0,i.__data[8]=o.elements[6],i.__data[9]=o.elements[7],i.__data[10]=o.elements[8],i.__data[11]=0):(o.toArray(i.__data,r),r+=s.storage/Float32Array.BYTES_PER_ELEMENT)}e.bufferSubData(e.UNIFORM_BUFFER,t,i.__data)}}}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function m(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=h(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function h(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?V(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):V(`WebGLRenderer: Unsupported uniform value type.`,e),t}function g(t){let n=t.target;n.removeEventListener(`dispose`,g);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function _(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:_}}var cl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),ll=null;function ul(){return ll===null&&(ll=new mi(cl,16,16,Ce,ue),ll.name=`DFG_LUT`,ll.minFilter=I,ll.magFilter=I,ll.wrapS=M,ll.wrapT=M,ll.generateMipmaps=!1,ll.needsUpdate=!0),ll}var dl=class{constructor(e={}){let{canvas:t=Ct(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=ie}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);p=n.getContextAttributes().alpha}else p=a;let m=f,h=new Set([Te,we,Se]),g=new Set([ie,ce,oe,pe,de,fe]),_=new Uint32Array(4),v=new Int32Array(4),y=null,b=null,x=[],S=[],C=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let w=this,T=!1;this._outputColorSpace=pt;let E=0,D=0,O=null,ee=-1,k=null,A=new an,j=new an,M=null,te=new Gn(0),N=0,P=t.width,F=t.height,I=1,ne=null,ae=null,L=new an(0,0,P,F),se=new an(0,0,P,F),le=!1,me=new Si,he=!1,ge=!1,_e=new un,ve=new G,ye=new an,be={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},xe=!1;function Ce(){return O===null?I:1}let R=n;function Ee(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r183`),t.addEventListener(`webglcontextlost`,Xe,!1),t.addEventListener(`webglcontextrestored`,Ze,!1),t.addEventListener(`webglcontextcreationerror`,Qe,!1),R===null){let t=`webgl2`;if(R=Ee(t,e),R===null)throw Ee(t)?Error(`Error creating WebGL context with your selected attributes.`):Error(`Error creating WebGL context.`)}}catch(e){throw H(`WebGLRenderer: `+e.message),e}let De,Oe,z,ke,B,Ae,je,Me,Ne,Pe,Fe,Ie,Le,Re,ze,Be,Ve,He,Ue,We,Ge,Ke,qe;function Je(){De=new Ao(R),De.init(),Ge=new $c(R,De),Oe=new ao(R,De,e,Ge),z=new Zc(R,De),Oe.reversedDepthBuffer&&d&&z.buffers.depth.setReversed(!0),ke=new No(R),B=new jc,Ae=new Qc(R,De,z,B,Oe,Ge,ke),je=new ko(w),Me=new Qa(R),Ke=new ro(R,Me),Ne=new jo(R,Me,ke,Ke),Pe=new Fo(R,Ne,Me,Ke,ke),He=new Po(R,Oe,Ae),ze=new oo(B),Fe=new Ac(w,je,De,Oe,Ke,ze),Ie=new ol(w,B),Le=new Fc,Re=new Hc(De),Ve=new X(w,je,z,Pe,p,s),Be=new Xc(w,Pe,Oe),qe=new sl(R,ke,Oe,z),Ue=new io(R,De,ke),We=new Mo(R,De,ke),ke.programs=Fe.programs,w.capabilities=Oe,w.extensions=De,w.properties=B,w.renderLists=Le,w.shadowMap=Be,w.state=z,w.info=ke}Je(),m!==1009&&(C=new Lo(m,t.width,t.height,r,i));let Ye=new rl(w,R);this.xr=Ye,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){let e=De.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=De.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return I},this.setPixelRatio=function(e){e!==void 0&&(I=e,this.setSize(P,F,!1))},this.getSize=function(e){return e.set(P,F)},this.setSize=function(e,n,r=!0){if(Ye.isPresenting){V(`WebGLRenderer: Can't change size while VR device is presenting.`);return}P=e,F=n,t.width=Math.floor(e*I),t.height=Math.floor(n*I),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),C!==null&&C.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(P*I,F*I).floor()},this.setDrawingBufferSize=function(e,n,r){P=e,F=n,I=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(m===1009){console.error(`THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){console.warn(`THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}C.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(A)},this.getViewport=function(e){return e.copy(L)},this.setViewport=function(e,t,n,r){e.isVector4?L.set(e.x,e.y,e.z,e.w):L.set(e,t,n,r),z.viewport(A.copy(L).multiplyScalar(I).round())},this.getScissor=function(e){return e.copy(se)},this.setScissor=function(e,t,n,r){e.isVector4?se.set(e.x,e.y,e.z,e.w):se.set(e,t,n,r),z.scissor(j.copy(se).multiplyScalar(I).round())},this.getScissorTest=function(){return le},this.setScissorTest=function(e){z.setScissorTest(le=e)},this.setOpaqueSort=function(e){ne=e},this.setTransparentSort=function(e){ae=e},this.getClearColor=function(e){return e.copy(Ve.getClearColor())},this.setClearColor=function(){Ve.setClearColor(...arguments)},this.getClearAlpha=function(){return Ve.getClearAlpha()},this.setClearAlpha=function(){Ve.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(O!==null){let t=O.texture.format;e=h.has(t)}if(e){let e=O.texture.type,t=g.has(e),n=Ve.getClearColor(),r=Ve.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(_[0]=i,_[1]=a,_[2]=o,_[3]=r,R.clearBufferuiv(R.COLOR,0,_)):(v[0]=i,v[1]=a,v[2]=o,v[3]=r,R.clearBufferiv(R.COLOR,0,v))}else r|=R.COLOR_BUFFER_BIT}t&&(r|=R.DEPTH_BUFFER_BIT),n&&(r|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&R.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener(`webglcontextlost`,Xe,!1),t.removeEventListener(`webglcontextrestored`,Ze,!1),t.removeEventListener(`webglcontextcreationerror`,Qe,!1),Ve.dispose(),Le.dispose(),Re.dispose(),B.dispose(),je.dispose(),Pe.dispose(),Ke.dispose(),qe.dispose(),Fe.dispose(),Ye.dispose(),Ye.removeEventListener(`sessionstart`,at),Ye.removeEventListener(`sessionend`,ot),st.stop()};function Xe(e){e.preventDefault(),Et(`WebGLRenderer: Context Lost.`),T=!0}function Ze(){Et(`WebGLRenderer: Context Restored.`),T=!1;let e=ke.autoReset,t=Be.enabled,n=Be.autoUpdate,r=Be.needsUpdate,i=Be.type;Je(),ke.autoReset=e,Be.enabled=t,Be.autoUpdate=n,Be.needsUpdate=r,Be.type=i}function Qe(e){H(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function $e(e){let t=e.target;t.removeEventListener(`dispose`,$e),et(t)}function et(e){tt(e),B.remove(e)}function tt(e){let t=B.get(e).programs;t!==void 0&&(t.forEach(function(e){Fe.releaseProgram(e)}),e.isShaderMaterial&&Fe.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=be);let o=i.isMesh&&i.matrixWorld.determinant()<0,s=vt(e,t,n,r,i);z.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ne.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;Ke.setup(i,r,s,n,c);let h,g=Ue;if(c!==null&&(h=Me.get(c),g=We,g.setIndex(h)),i.isMesh)r.wireframe===!0?(z.setLineWidth(r.wireframeLinewidth*Ce()),g.setMode(R.LINES)):g.setMode(R.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),z.setLineWidth(e*Ce()),i.isLineSegments?g.setMode(R.LINES):i.isLineLoop?g.setMode(R.LINE_LOOP):g.setMode(R.LINE_STRIP)}else i.isPoints?g.setMode(R.POINTS):i.isSprite&&g.setMode(R.TRIANGLES);if(i.isBatchedMesh)if(i._multiDrawInstances!==null)Ot(`WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection.`),g.renderMultiDrawInstances(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount,i._multiDrawInstances);else if(De.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Me.get(c).bytesPerElement:1,o=B.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(R,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function nt(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,ht(e,t,n),e.side=0,e.needsUpdate=!0,ht(e,t,n),e.side=2):ht(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),b=Re.get(n),b.init(t),S.push(b),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(b.pushLight(e),e.castShadow&&b.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(b.pushLight(e),e.castShadow&&b.pushShadow(e))}),b.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];nt(a,n,e),r.add(a)}else nt(t,n,e),r.add(t)}),b=S.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){B.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}De.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let rt=null;function it(e){rt&&rt(e)}function at(){st.stop()}function ot(){st.start()}let st=new Za;st.setAnimationLoop(it),typeof self<`u`&&st.setContext(self),this.setAnimationLoop=function(e){rt=e,Ye.setAnimationLoop(e),e===null?st.stop():st.start()},Ye.addEventListener(`sessionstart`,at),Ye.addEventListener(`sessionend`,ot),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){H(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(T===!0)return;let n=Ye.enabled===!0&&Ye.isPresenting===!0,r=C!==null&&(O===null||n)&&C.begin(w,O);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),Ye.enabled===!0&&Ye.isPresenting===!0&&(C===null||C.isCompositing()===!1)&&(Ye.cameraAutoUpdate===!0&&Ye.updateCamera(t),t=Ye.getCamera()),e.isScene===!0&&e.onBeforeRender(w,e,t,O),b=Re.get(e,S.length),b.init(t),S.push(b),_e.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),me.setFromProjectionMatrix(_e,yt,t.reversedDepth),ge=this.localClippingEnabled,he=ze.init(this.clippingPlanes,ge),y=Le.get(e,x.length),y.init(),x.push(y),Ye.enabled===!0&&Ye.isPresenting===!0){let e=w.xr.getDepthSensingMesh();e!==null&&ct(e,t,-1/0,w.sortObjects)}ct(e,t,0,w.sortObjects),y.finish(),w.sortObjects===!0&&y.sort(ne,ae),xe=Ye.enabled===!1||Ye.isPresenting===!1||Ye.hasDepthSensing()===!1,xe&&Ve.addToRenderList(y,e),this.info.render.frame++,he===!0&&ze.beginShadows();let i=b.state.shadowsArray;if(Be.render(i,e,t),he===!0&&ze.endShadows(),this.info.autoReset===!0&&this.info.reset(),(r&&C.hasRenderPass())===!1){let n=y.opaque,r=y.transmissive;if(b.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];ut(n,r,e,a)}xe&&Ve.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];lt(y,e,n,n.viewport)}}else r.length>0&&ut(n,r,e,t),xe&&Ve.render(e),lt(y,e,t)}O!==null&&D===0&&(Ae.updateMultisampleRenderTarget(O),Ae.updateRenderTargetMipmap(O)),r&&C.end(w),e.isScene===!0&&e.onAfterRender(w,e,t),Ke.resetDefaultState(),ee=-1,k=null,S.pop(),S.length>0?(b=S[S.length-1],he===!0&&ze.setGlobalState(w.clippingPlanes,b.state.camera)):b=null,x.pop(),y=x.length>0?x[x.length-1]:null};function ct(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLight)b.pushLight(e),e.castShadow&&b.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||me.intersectsSprite(e)){r&&ye.setFromMatrixPosition(e.matrixWorld).applyMatrix4(_e);let t=Pe.update(e),i=e.material;i.visible&&y.push(e,t,i,n,ye.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||me.intersectsObject(e))){let t=Pe.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),ye.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),ye.copy(e.boundingSphere.center)),ye.applyMatrix4(e.matrixWorld).applyMatrix4(_e)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&y.push(e,t,s,n,ye.z,o)}}else i.visible&&y.push(e,t,i,n,ye.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)ct(i[e],t,n,r)}function lt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;b.setupLightsView(n),he===!0&&ze.setGlobalState(w.clippingPlanes,n),r&&z.viewport(A.copy(r)),i.length>0&&dt(i,t,n),a.length>0&&dt(a,t,n),o.length>0&&dt(o,t,n),z.buffers.depth.setTest(!0),z.buffers.depth.setMask(!0),z.buffers.color.setMask(!0),z.setPolygonOffset(!1)}function ut(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[r.id]===void 0){let e=De.has(`EXT_color_buffer_half_float`)||De.has(`EXT_color_buffer_float`);b.state.transmissionRenderTarget[r.id]=new sn(1,1,{generateMipmaps:!0,type:e?ue:ie,minFilter:re,samples:Oe.samples,stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:qt.workingColorSpace})}let a=b.state.transmissionRenderTarget[r.id],o=r.viewport||A;a.setSize(o.z*w.transmissionResolutionScale,o.w*w.transmissionResolutionScale);let s=w.getRenderTarget(),c=w.getActiveCubeFace(),l=w.getActiveMipmapLevel();w.setRenderTarget(a),w.getClearColor(te),N=w.getClearAlpha(),N<1&&w.setClearColor(16777215,.5),w.clear(),xe&&Ve.render(n);let u=w.toneMapping;w.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),b.setupLightsView(r),he===!0&&ze.setGlobalState(w.clippingPlanes,r),dt(e,n,r),Ae.updateMultisampleRenderTarget(a),Ae.updateRenderTargetMipmap(a),De.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,ft(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(Ae.updateMultisampleRenderTarget(a),Ae.updateRenderTargetMipmap(a))}w.setRenderTarget(s,c,l),w.setClearColor(te,N),d!==void 0&&(r.viewport=d),w.toneMapping=u}function dt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&ft(o,t,n,s,l,c)}}function ft(e,t,n,r,i,a){e.onBeforeRender(w,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(w,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,w.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,w.renderBufferDirect(n,t,r,i,e,a),i.side=2):w.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(w,t,n,r,i,a)}function ht(e,t,n){t.isScene!==!0&&(t=be);let r=B.get(e),i=b.state.lights,a=b.state.shadowsArray,o=i.state.version,s=Fe.getParameters(e,i.state,a,t,n),c=Fe.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=je.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,$e),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return _t(e,s),d}else s.uniforms=Fe.getUniforms(e),e.onBeforeCompile(s,w),d=Fe.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=ze.uniform),_t(e,s),r.needsLights=xt(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.currentProgram=d,r.uniformsList=null,d}function gt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Ws.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function _t(e,t){let n=B.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function vt(e,t,n,r,i){t.isScene!==!0&&(t=be),Ae.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=O===null?w.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:mt,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=je.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(h=w.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=B.get(r),y=b.state.lights;if(he===!0&&(ge===!0||e!==k)){let t=e===k&&r.id===ee;ze.setState(r,e,t)}let x=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?x=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?x=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==ze.numPlanes||v.numIntersection!==ze.numIntersection)?x=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h?v.morphTargetsCount!==_&&(x=!0):x=!0:x=!0:x=!0:(x=!0,v.__version=r.version);let S=v.currentProgram;x===!0&&(S=ht(r,t,i));let C=!1,T=!1,E=!1,D=S.getUniforms(),A=v.uniforms;if(z.useProgram(S.program)&&(C=!0,T=!0,E=!0),r.id!==ee&&(ee=r.id,T=!0),C||k!==e){z.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),D.setValue(R,`projectionMatrix`,e.projectionMatrix),D.setValue(R,`viewMatrix`,e.matrixWorldInverse);let t=D.map.cameraPosition;t!==void 0&&t.setValue(R,ve.setFromMatrixPosition(e.matrixWorld)),Oe.logarithmicDepthBuffer&&D.setValue(R,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&D.setValue(R,`isOrthographic`,e.isOrthographicCamera===!0),k!==e&&(k=e,T=!0,E=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&D.setValue(R,`directionalShadowMap`,y.state.directionalShadowMap,Ae),y.state.spotShadowMap.length>0&&D.setValue(R,`spotShadowMap`,y.state.spotShadowMap,Ae),y.state.pointShadowMap.length>0&&D.setValue(R,`pointShadowMap`,y.state.pointShadowMap,Ae)),i.isSkinnedMesh){D.setOptional(R,i,`bindMatrix`),D.setOptional(R,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),D.setValue(R,`boneTexture`,e.boneTexture,Ae))}i.isBatchedMesh&&(D.setOptional(R,i,`batchingTexture`),D.setValue(R,`batchingTexture`,i._matricesTexture,Ae),D.setOptional(R,i,`batchingIdTexture`),D.setValue(R,`batchingIdTexture`,i._indirectTexture,Ae),D.setOptional(R,i,`batchingColorTexture`),i._colorsTexture!==null&&D.setValue(R,`batchingColorTexture`,i._colorsTexture,Ae));let j=n.morphAttributes;if((j.position!==void 0||j.normal!==void 0||j.color!==void 0)&&He.update(i,n,S),(T||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,D.setValue(R,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(A.envMapIntensity.value=t.environmentIntensity),A.dfgLUT!==void 0&&(A.dfgLUT.value=ul()),T&&(D.setValue(R,`toneMappingExposure`,w.toneMappingExposure),v.needsLights&&bt(A,E),a&&r.fog===!0&&Ie.refreshFogUniforms(A,a),Ie.refreshMaterialUniforms(A,r,I,F,b.state.transmissionRenderTarget[e.id]),Ws.upload(R,gt(v),A,Ae)),r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Ws.upload(R,gt(v),A,Ae),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&D.setValue(R,`center`,i.center),D.setValue(R,`modelViewMatrix`,i.modelViewMatrix),D.setValue(R,`normalMatrix`,i.normalMatrix),D.setValue(R,`modelMatrix`,i.matrixWorld),r.isShaderMaterial||r.isRawShaderMaterial){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];qe.update(n,S),qe.bind(n,S)}}return S}function bt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function xt(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return E},this.getActiveMipmapLevel=function(){return D},this.getRenderTarget=function(){return O},this.setRenderTargetTextures=function(e,t,n){let r=B.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),B.get(e.texture).__webglTexture=t,B.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=B.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0};let St=R.createFramebuffer();this.setRenderTarget=function(e,t=0,n=0){O=e,E=t,D=n;let r=null,i=!1,a=!1;if(e){let o=B.get(e);if(o.__useDefaultFramebuffer!==void 0){z.bindFramebuffer(R.FRAMEBUFFER,o.__webglFramebuffer),A.copy(e.viewport),j.copy(e.scissor),M=e.scissorTest,z.viewport(A),z.scissor(j),z.setScissorTest(M),ee=-1;return}else if(o.__webglFramebuffer===void 0)Ae.setupRenderTarget(e);else if(o.__hasExternalTextures)Ae.rebindTextures(e,B.get(e.texture).__webglTexture,B.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&B.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.`);Ae.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=B.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&Ae.useMultisampledRTT(e)===!1?B.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,A.copy(e.viewport),j.copy(e.scissor),M=e.scissorTest}else A.copy(L).multiplyScalar(I).floor(),j.copy(se).multiplyScalar(I).floor(),M=le;if(n!==0&&(r=St),z.bindFramebuffer(R.FRAMEBUFFER,r)&&z.drawBuffers(e,r),z.viewport(A),z.scissor(j),z.setScissorTest(M),i){let r=B.get(e.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=B.get(e.textures[t]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=B.get(e.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,t.__webglTexture,n)}ee=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=B.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){z.bindFramebuffer(R.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+s),!Oe.textureFormatReadable(c)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Oe.textureTypeReadable(l)){H(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&R.readPixels(t,n,r,i,Ge.convert(c),Ge.convert(l),a)}finally{let e=O===null?null:B.get(O).__webglFramebuffer;z.bindFramebuffer(R.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=B.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){z.bindFramebuffer(R.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+s),!Oe.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Oe.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,d),R.bufferData(R.PIXEL_PACK_BUFFER,a.byteLength,R.STREAM_READ),R.readPixels(t,n,r,i,Ge.convert(l),Ge.convert(u),0);let f=O===null?null:B.get(O).__webglFramebuffer;z.bindFramebuffer(R.FRAMEBUFFER,f);let p=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await kt(R,p,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,d),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,a),R.deleteBuffer(d),R.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;Ae.setTexture2D(e,0),R.copyTexSubImage2D(R.TEXTURE_2D,n,0,0,o,s,i,a),z.unbindTexture()};let wt=R.createFramebuffer(),Tt=R.createFramebuffer();this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=Ge.convert(t.format),_=Ge.convert(t.type),v;t.isData3DTexture?(Ae.setTexture3D(t,0),v=R.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(Ae.setTexture2DArray(t,0),v=R.TEXTURE_2D_ARRAY):(Ae.setTexture2D(t,0),v=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,t.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,t.unpackAlignment);let y=R.getParameter(R.UNPACK_ROW_LENGTH),b=R.getParameter(R.UNPACK_IMAGE_HEIGHT),x=R.getParameter(R.UNPACK_SKIP_PIXELS),S=R.getParameter(R.UNPACK_SKIP_ROWS),C=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,h.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,h.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,l),R.pixelStorei(R.UNPACK_SKIP_ROWS,u),R.pixelStorei(R.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=B.get(e),r=B.get(t),h=B.get(n.__renderTarget),g=B.get(r.__renderTarget);z.bindFramebuffer(R.READ_FRAMEBUFFER,h.__webglFramebuffer),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,B.get(e).__webglTexture,i,d+n),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,B.get(t).__webglTexture,a,m+n)),R.blitFramebuffer(l,u,o,s,f,p,o,s,R.DEPTH_BUFFER_BIT,R.NEAREST);z.bindFramebuffer(R.READ_FRAMEBUFFER,null),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||B.has(e)){let n=B.get(e),r=B.get(t);z.bindFramebuffer(R.READ_FRAMEBUFFER,wt),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,Tt);for(let e=0;e<c;e++)w?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,n.__webglTexture,i),T?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,r.__webglTexture,a),i===0?T?R.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):R.copyTexSubImage2D(v,a,f,p,l,u,o,s):R.blitFramebuffer(l,u,o,s,f,p,o,s,R.COLOR_BUFFER_BIT,R.NEAREST);z.bindFramebuffer(R.READ_FRAMEBUFFER,null),z.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?R.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?R.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):R.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):R.texSubImage2D(R.TEXTURE_2D,a,f,p,o,s,g,_,h);R.pixelStorei(R.UNPACK_ROW_LENGTH,y),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,b),R.pixelStorei(R.UNPACK_SKIP_PIXELS,x),R.pixelStorei(R.UNPACK_SKIP_ROWS,S),R.pixelStorei(R.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&R.generateMipmap(v),z.unbindTexture()},this.initRenderTarget=function(e){B.get(e).__webglFramebuffer===void 0&&Ae.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?Ae.setTextureCube(e,0):e.isData3DTexture?Ae.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?Ae.setTexture2DArray(e,0):Ae.setTexture2D(e,0),z.unbindTexture()},this.resetState=function(){E=0,D=0,O=null,z.reset(),Ke.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return yt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=qt._getDrawingBufferColorSpace(e),t.unpackColorSpace=qt._getUnpackColorSpace()}},fl=.08;function pl(e,t,n){return Math.max(t,Math.min(n,e))}function ml(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}var hl=null;function gl(){return hl||=new(window.AudioContext||window.webkitAudioContext),hl}function _l(){let e=gl(),t=e.currentTime,n=e.createBuffer(1,e.sampleRate*.045,e.sampleRate),r=n.getChannelData(0);for(let t=0;t<r.length;t++){let n=t/e.sampleRate;r[t]=(Math.random()*2-1)*Math.exp(-n*280)*.9+(Math.random()*2-1)*Math.exp(-n*80)*.35+Math.sin(n*2800*Math.PI*2)*Math.exp(-n*600)*.12}let i=e.createBufferSource();i.buffer=n;let a=e.createGain();a.gain.setValueAtTime(.38+Math.random()*.08,t),i.playbackRate.value=.94+Math.random()*.14;let o=e.createBiquadFilter();o.type=`bandpass`,o.frequency.value=1800,o.Q.value=.7,i.connect(o),o.connect(a),a.connect(e.destination),i.start(t)}function vl(){let e=gl(),t=e.currentTime;for(let n=0;n<3;n++){let r=e.createBuffer(1,e.sampleRate*.18,e.sampleRate),i=r.getChannelData(0);for(let t=0;t<i.length;t++){let n=t/e.sampleRate;i[t]=(Math.random()*2-1)*Math.exp(-n*22)*.5+Math.sin(n*320*Math.PI*2)*Math.exp(-n*18)*.2}let a=e.createBufferSource();a.buffer=r;let o=e.createGain();o.gain.setValueAtTime(.22,t+n*.04),a.connect(o),o.connect(e.destination),a.start(t+n*.04)}}function yl(){let e=gl(),t=e.currentTime,n=e.createOscillator();n.type=`sine`,n.frequency.setValueAtTime(1480,t),n.frequency.exponentialRampToValueAtTime(1200,t+.55);let r=e.createGain();r.gain.setValueAtTime(0,t),r.gain.linearRampToValueAtTime(.28,t+.006),r.gain.exponentialRampToValueAtTime(.001,t+.8);let i=e.createOscillator();i.type=`sine`,i.frequency.setValueAtTime(2960,t);let a=e.createGain();a.gain.setValueAtTime(.06,t),a.gain.exponentialRampToValueAtTime(.001,t+.35),n.connect(r),i.connect(a),r.connect(e.destination),a.connect(e.destination),n.start(t),n.stop(t+.85),i.start(t),i.stop(t+.4)}function bl(){let e=gl(),t=e.currentTime,n=e.createBuffer(1,e.sampleRate*.03,e.sampleRate),r=n.getChannelData(0);for(let t=0;t<r.length;t++){let n=t/e.sampleRate;r[t]=(Math.random()*2-1)*Math.exp(-n*400)*.25}let i=e.createBufferSource();i.buffer=n;let a=e.createGain();a.gain.value=.6,i.connect(a),a.connect(e.destination),i.start(t)}function xl(){let e=gl(),t=e.currentTime,n=e.createBuffer(1,e.sampleRate*.06,e.sampleRate),r=n.getChannelData(0);for(let t=0;t<r.length;t++){let n=t/e.sampleRate;r[t]=(Math.random()*2-1)*Math.exp(-n*180)*.3+Math.sin(n*600*Math.PI*2)*Math.exp(-n*200)*.08}let i=e.createBufferSource();i.buffer=n,i.playbackRate.value=.9+Math.random()*.1;let a=e.createGain();a.gain.value=.5,i.connect(a),a.connect(e.destination),i.start(t)}function Sl({containerRef:e}){let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let n=t.current,r=e.current;if(!n||!r)return;let i=r.clientWidth,a=r.clientHeight,o=new dl({antialias:!0,canvas:n,alpha:!1,powerPreference:`high-performance`});o.setSize(i,a),o.setPixelRatio(Math.min(devicePixelRatio,2)),o.setClearColor(854277,1),o.shadowMap.enabled=!0,o.shadowMap.type=2,o.outputEncoding=void 0,o.toneMapping=4,o.toneMappingExposure=2.4,o.physicallyCorrectLights=!0;let s=new Jn;s.fog=new qn(854277,.022);let c=new ba(34,i/a,.05,120);c.position.set(0,3.8,38);let l=new Sa(16765056,600,55,Math.PI/3.8,.38,1.3);l.position.set(7,18,10),l.castShadow=!0,l.shadow.mapSize.set(2048,2048),l.shadow.bias=-2e-4,l.shadow.camera.near=4,l.shadow.camera.far=52,s.add(l,l.target);let u=new Da(13135920,1.8);u.position.set(-9,6,4),s.add(u);let d=new Sa(16755232,80,35,Math.PI/2.8,.55,1.6);d.position.set(-6,12,-14),s.add(d);let f=new wa(16747552,3.5,12,1.8);f.position.set(0,-.5,2),s.add(f);let p=new wa(16740368,0,18,2);p.position.set(3,3,5),s.add(p),s.add(new ca(8014360,1182210,2.2));let m=new di(new ki(28,24),new Mi({opacity:.38}));m.rotation.x=-Math.PI/2,m.position.y=-.01,m.receiveShadow=!0,s.add(m);let h=(e,t,n,r={})=>new Hi({color:e,roughness:t,metalness:n,...r}),g={body:h(2760206,.78,.1),bodyD:h(1971208,.85,.08),bodyHL:h(4008466,.62,.14),chrome:h(13936690,.08,.95),chromeD:h(12094498,.22,.9),brass:h(13144602,.18,.92),brassW:h(11040792,.32,.85),rubber:h(1708040,.98,0),ebonite:h(657414,.7,.05),keyRing:h(14727232,.12,.94),ink:h(1314310,.96,0),red:h(9183248,.5,.06),blue:h(1583240,.5,.06),typebar:h(13146664,.2,.88)},_=new Rn;s.add(_);function v(e,t,n=0,r=0,i=0,a=0,o=0,s=0,c=_){let l=new di(e,t);return l.position.set(n,r,i),l.rotation.set(a,o,s),l.castShadow=!0,l.receiveShadow=!0,c.add(l),l}let y=(e,t,n)=>new Di(e,t,n),b=(e,t,n,r=32)=>new Oi(e,t,n,r),x=(e,t=20)=>new Ai(e,t,t),S=(e,t,n=16,r=40,i=Math.PI*2)=>new ji(e,t,n,r,i);v(y(7.1,.52,5.2),g.bodyD,0,.26,.1);for(let[e,t]of[[-2.8,-2.2],[-2.8,2.15],[2.8,-2.2],[2.8,2.15]])v(b(.25,.28,.15,18),g.rubber,e,.07,t);for(let e of[-3.14,3.14]){let t=Math.sign(e);v(y(.46,1.55,5.05),g.body,e,.98,.1),v(y(.36,.28,4.8),g.bodyHL,e,1.72,.1),v(y(.058,1.55,.055),g.chrome,e+t*.03,.98,-2.38),v(y(.058,1.55,.055),g.chrome,e+t*.03,.98,2.52)}v(y(7.1,1.55,.46),g.body,0,.98,2.36),v(y(5,.72,.07),g.bodyD,0,.9,2.43),v(y(2.2,.36,.09),g.brass,0,.9,2.44),v(y(1.96,.24,.06),g.bodyD,0,.9,2.46),v(y(6.8,.06,.06),g.chrome,0,1.46,2.38),v(y(6.8,.06,.06),g.chrome,0,.52,2.38),v(y(7.1,1.25,.46),g.bodyD,0,.83,-2.28);for(let e=0;e<9;e++)v(y(4.4,.04,.03),h(1576452,.93,0),0,.3+e*.11,-2.28);v(y(6.4,.26,4.4),g.body,0,1.74,.12),v(y(5.75,.1,3.7),g.bodyD,0,1.88,.12);for(let e=-2.95;e<=2.95;e+=.47)v(b(.037,.037,.044,8),g.brass,e,1.46,2.39),v(b(.037,.037,.044,8),g.brass,e,.54,2.39);for(let e of[-3.14,3.14])for(let t=.36;t<=1.38;t+=.46)v(b(.037,.037,.044,8),g.brass,e,t,.1);for(let[e,t]of[[-2.85,-2.1],[-2.85,2.15],[2.85,-2.1],[2.85,2.15]])v(b(.04,.04,.044,8),g.brass,e,1.87,t);v(y(7.8,.13,.13),g.chrome,0,1.87,-.6),v(y(7.8,.13,.13),g.chrome,0,1.87,.6);for(let e of[-3.9,3.9])v(b(.16,.16,.27,18),g.chrome,e,1.87,0,0,0,Math.PI/2);for(let e=-2.8;e<=2.8;e+=1.4)v(y(.11,.3,1.32),g.chromeD,e,2.02,0);let C=6.4,w=.168;w*37/2,v(y(C,.1,.19),g.chromeD,0,1.79,0);for(let e=0;e<38;e++)v(y(.056,.12,.056),g.chrome,-3.108+e*w,1.86,0);v(y(.13,.25,.12),g.brass,C/2+.14,1.84,0),v(y(.25,.09,.12),g.brass,C/2+.07,1.78,0);let T=new Rn;T.position.set(0,1.88,0),_.add(T);function E(e,t,n=0,r=0,i=0,a=0,o=0,s=0){return v(e,t,n,r,i,a,o,s,T)}E(y(5.8,.38,1.45),g.body),E(y(5.6,.06,.06),g.chrome,0,.22,.74),E(y(5.6,.06,.06),g.chrome,0,.22,-.74);for(let e of[-2.92,2.92])E(y(.22,.44,1.45),g.chromeD,e,.07,0);let D=h(0,.97,0),O=new di(b(.55,.55,6.1,64),D);O.rotation.z=Math.PI/2,O.position.set(0,.6,-.06),O.castShadow=!0,O.receiveShadow=!0,T.add(O);for(let e of[-3.1,3.1]){let t=new di(b(.565,.565,.18,36),g.chrome);t.rotation.z=Math.PI/2,t.position.set(e,.6,-.06),T.add(t)}let ee=new di(b(.38,.34,.34,22),g.chrome);ee.rotation.z=Math.PI/2,ee.position.set(3.34,.6,-.06),T.add(ee);let k=new di(b(.38,.34,.34,22),g.chrome);k.rotation.z=Math.PI/2,k.position.set(-3.34,.6,-.06),T.add(k);let A=document.createElement(`canvas`);A.width=512,A.height=1024;let j=A.getContext(`2d`),M=new wi(A),te=new Hi({map:M,roughness:.82,metalness:0,side:2,transparent:!0,opacity:1}),N=new di(new ki(3.65,2.1,1,60),te);N.position.set(0,2.2,-.09),N.rotation.x=-.05,N.castShadow=!0,N.receiveShadow=!0,T.add(N);let P=0,F=!1,I=0,ne=0,re=new di(b(.052,.052,4.95,18),g.chrome);re.rotation.z=Math.PI/2,re.position.set(0,.68,.7),T.add(re);for(let e of[-1.75,1.75]){let t=new di(b(.11,.11,.09,14),g.chrome);t.rotation.z=Math.PI/2,t.position.set(e,.68,.7),T.add(t)}for(let e of[-1.02,1.02])E(y(.09,.36,.09),g.chromeD,e,.84,.66);E(y(4.9,.09,.28),g.chromeD,0,.9,.88);let ie=new Rn;ie.position.set(-3.8,1.88,0),_.add(ie),v(y(.11,.11,1.18),g.chrome,0,0,.59,0,0,0,ie),v(y(.11,.66,.11),g.chrome,0,.33,1.18,0,0,0,ie),v(x(.155,15),g.rubber,0,.7,1.18,0,0,0,ie);for(let e of[-2.14,1.68])E(y(.17,.32,.34),g.red,e,.25,-.25);let ae=new di(S(2,.078,15,72,Math.PI*1.12),g.chromeD);ae.position.set(0,1.76,1.14),ae.rotation.x=-Math.PI*.42,_.add(ae);let L=new di(S(1.74,.057,11,68,Math.PI*1.1),g.body);L.position.set(0,1.76,1.14),L.rotation.x=-Math.PI*.42,_.add(L),v(y(4.95,.09,.28),g.chromeD,0,1.92,.88);let oe=[];for(let e=0;e<2;e++)for(let t=0;t<46;t++){let n=t/45*Math.PI-Math.PI/2,r=new Rn,i=new di(y(.04,1.22,.026),g.typebar);i.castShadow=!0,r.add(i);let a=new di(y(.09,.115,.068),g.ink);a.position.set(0,.67,0),r.add(a);let o=new di(b(.046,.046,.065,10),g.chromeD);o.position.set(0,-.58,0),o.rotation.z=Math.PI/2,r.add(o);let s=e===0?1:-1;r.position.set(s*Math.cos(n)*1.85*.52,1.76+Math.abs(Math.sin(n))*.2,1.14+Math.sin(n)*.48),r.rotation.x=-Math.PI*.42+Math.sin(n)*.14,r.rotation.z=s*(-n*.08),_.add(r),oe.push({g:r,baseY:r.position.y,baseRX:r.rotation.x})}for(let e of[-2.1,2.1])v(b(.088,.088,.26,14),g.chromeD,e,1.84,-.6),v(b(.52,.52,.062,40),g.chromeD,e,1.75,-.6),v(b(.36,.36,.3,40),g.ink,e,1.9,-.6),v(b(.52,.52,.062,40),g.chrome,e,2.06,-.6),v(b(.54,.48,.13,36),h(1841172,.52,.22,{transparent:!0,opacity:.7}),e,2.12,-.6),v(b(.078,.078,.072,6),g.brass,e,2.16,-.6);v(y(4.22,.056,.03),h(788488,.95,0),0,1.9,-.56),v(y(.068,.44,.046),g.chromeD,0,1.76,.74),v(y(.25,.068,.046),g.chromeD,0,1.98,.74);for(let e of[-.6,.6])v(S(.066,.022,8,18),g.chrome,e,1.9,.56,Math.PI/2,0,0);v(y(.6,.15,.58),g.bodyD,-3.02,1.72,1.18),v(y(.48,.12,.24),g.red,-3.02,1.8,1.06),v(y(.48,.12,.24),g.blue,-3.02,1.8,1.28),v(y(.046,.022,.065),h(13551264,.82,0),-3.02,1.87,1.17),v(y(.09,.32,.09),g.chromeD,-3.02,1.94,1.17),v(x(.088,12),g.rubber,-3.02,2.1,1.17),v(x(.145,20),g.brass,3.16,1.78,-.58),v(b(.057,.057,.34,11),g.chromeD,3.16,1.62,-.58);for(let e of[-1.64,1.64])v(b(.074,.074,.058,12),g.brassW,e,1.87,-1.7);let se=new Rn;se.position.set(0,.98,3.17),se.rotation.x=.32,_.add(se),v(y(5.2,.24,1.9),g.body,0,0,0,0,0,0,se);let ce=.34,le=12*ce/2,ue=.12,de=[],fe=`1234567890-=+azertyuiopqsdf ghj`.split(``),pe=h(0,.6,.05),me=h(0,.4,.1),he=h(9133628,.7,.05),ge=new $r({visible:!1}),_e=0;function ve(e,t,n){let r=fe[_e++]??null,i=v(b(.09,.1,.28,18),he,e,t,n,0,0,0,se);v(S(.128,.026,10,26),g.keyRing,e,t+.155,n,Math.PI/2,0,0,se);let a=v(b(.112,.116,.07,24),pe,e,t+.19,n,0,0,0,se);v(b(.072,.072,.014,20),me,e,t+.228,n,0,0,0,se);let o=new di(new Ai(.18,8,8),ge);o.position.set(e,t+.2,n),se.add(o),de.push({stem:i,cap:a,hit:o,baseY:t,char:r})}for(let e=0;e<13;e++)ve(-le+e*ce,ue,-.45);let ye=-le+ce;for(let e=0;e<11;e++)ve(ye+e*ce,ue,0);for(let e=0;e<3;e++)ve(-le+e*ce,ue,.45);v(y(2.2,.075,.28),g.keyRing,0,ue+.175,.45,0,0,0,se),v(y(2.08,.06,.18),pe,0,ue+.19,.45,0,0,0,se),v(y(1.96,.045,.1),me,0,ue+.202,.45,0,0,0,se);let be=new di(new Di(2.2,.25,.3),ge);be.position.set(0,ue+.2,.45),se.add(be),de.push({stem:null,cap:be,hit:be,baseY:ue,char:` `});for(let e=0;e<3;e++)ve(-le+3*ce+2.35+e*ce,ue,.45);let xe=new Ga,Se=new W,Ce=de.map(e=>e.hit),we=new Map(de.map(e=>[e.hit,e])),Te=[``],R=0,Ee=2.2,De=0,Oe=0;function z(){let e=j.createLinearGradient(0,0,512,0);e.addColorStop(0,`#f4eed6`),e.addColorStop(.5,`#faf5e2`),e.addColorStop(1,`#f4eed6`),j.fillStyle=e,j.fillRect(0,0,512,1024),j.strokeStyle=`rgba(155,130,75,.13)`,j.lineWidth=1;for(let e=60;e<1024;e+=42)j.beginPath(),j.moveTo(0,e),j.lineTo(512,e),j.stroke();j.strokeStyle=`rgba(175,55,55,.20)`,j.lineWidth=2,j.beginPath(),j.moveTo(30,0),j.lineTo(30,1024),j.stroke(),j.font=`18px "Courier New", monospace`,Te.slice(Math.max(0,R-24),R+1).forEach((e,t)=>{let n=48+t*38;if(!(n>1010)){j.fillStyle=`rgba(12,8,2,.82)`;for(let t=0;t<e.length;t++){let r=36+t*11.8;if(r>476)break;j.fillText(e[t],r+(Math.random()-.5)*.5,n+(Math.random()-.5)*.5)}}}),M.needsUpdate=!0}z();let ke=null,B=null;function Ae(e){if(B!==null){let e=oe[B];e.g.position.y=e.baseY,e.g.rotation.x=e.baseRX}ke&&clearTimeout(ke);let t=oe[e];t.g.position.y=t.baseY+.3,t.g.rotation.x=t.baseRX+.36,B=e,ke=setTimeout(()=>{t.g.position.y=t.baseY,t.g.rotation.x=t.baseRX,B=null},110)}let je=null,Me=null;function Ne(e){if(Me!==null){let e=de[Me];e.cap&&(e.cap.position.y=e.baseY+.19),e.stem&&(e.stem.position.y=e.baseY)}je&&clearTimeout(je);let t=de[e];t.cap&&(t.cap.position.y=t.baseY+.11),t.stem&&(t.stem.position.y=t.baseY-.06),Me=e,je=setTimeout(()=>{t.cap&&(t.cap.position.y=t.baseY+.19),t.stem&&(t.stem.position.y=t.baseY),Me=null},110)}function Pe(){let e=O.rotation.x,t=e+Math.PI/4,n=0,r=()=>{n+=.07,O.rotation.x=e+(t-e)*Math.min(n,1),n<1&&requestAnimationFrame(r)};r()}function Fe(e){gl(),e===`\b`?Te[R].length>0?(Te[R]=Te[R].slice(0,-1),Ee=Math.min(2.2,Ee+.122),De=Math.max(0,De-1),ne=Math.max(0,ne-1),P=ne/720,bl()):R>0&&(Te.pop(),R--,Ee=2.2-Te[R].length/36*4.4,bl()):e===`
`?(Te.push(``),R++,Ee=2.2,ne=Math.min(720,ne+36),P=ne/720,vl(),Pe(),Oe=.18):(Te[R].length>=36&&(Te.push(``),R++,Ee=2.2,vl(),Pe(),Oe=.18),Te[R]+=e,Ee-=.122,Ee=Math.max(-2.2,Ee),De++,ne++,P=Math.min(1,ne/720),Te[R].length===32?yl():e===` `?xl():_l(),Ae(Math.floor(Math.random()*oe.length)),Ne(Math.floor(Math.random()*de.length))),P>=1&&!F&&(F=!0,I=0),z()}function Ie(e){e.ctrlKey||e.metaKey||e.altKey||(e.key===`Backspace`?(e.preventDefault(),Fe(`\b`)):e.key===`Enter`?(e.preventDefault(),Fe(`
`)):e.key.length===1&&(e.preventDefault(),Fe(e.key)))}window.addEventListener(`keydown`,Ie);let Le=!1,Re=!1,ze=0,Be=0,Ve=0,He=0,Ue=.28,We=0,Ge=.28,Ke=0,qe=38,Je=-.65,Ye=.19,Xe=.088;function Ze(e){Le=!0,ze=e.clientX,Be=e.clientY,gl()}function Qe(){Le=!1}function $e(e){Le&&(Ge+=(e.clientX-ze)*.007,ze=e.clientX,Ke+=(e.clientY-Be)*.005,Be=e.clientY,Ke=Math.max(Je,Math.min(Ye,Ke)))}function et(e){Ve=e.touches[0].clientX,He=e.touches[0].clientY,Re=!0,Le=!0,ze=Ve,Be=He,gl()}function tt(e){if(Le=!1,Re){let t=e.changedTouches[0].clientX-Ve,r=e.changedTouches[0].clientY-He;if(Math.sqrt(t*t+r*r)<10){let t=n.getBoundingClientRect();Se.x=(e.changedTouches[0].clientX-t.left)/t.width*2-1,Se.y=-((e.changedTouches[0].clientY-t.top)/t.height)*2+1,xe.setFromCamera(Se,c);let r=xe.intersectObjects(Ce,!1);if(r.length>0){let e=we.get(r[0].object);e?.char&&Fe(e.char)}}}Re=!1}function nt(e){if(!Le)return;e.preventDefault(),e.stopPropagation();let t=e.touches[0].clientX-Ve,n=e.touches[0].clientY-He;Math.sqrt(t*t+n*n)>10&&(Re=!1),Ge+=(e.touches[0].clientX-ze)*.007,ze=e.touches[0].clientX,Ke+=(e.touches[0].clientY-Be)*.005,Be=e.touches[0].clientY,Ke=Math.max(Je,Math.min(Ye,Ke))}function rt(e){if(Le)return;let t=n.getBoundingClientRect();Se.x=(e.clientX-t.left)/t.width*2-1,Se.y=-((e.clientY-t.top)/t.height)*2+1,xe.setFromCamera(Se,c);let r=xe.intersectObjects(Ce,!1);if(r.length>0){let e=we.get(r[0].object);e?.char&&Fe(e.char)}}function it(e){!e.ctrlKey&&!e.metaKey||(e.preventDefault(),e.stopPropagation(),qe+=e.deltaY*.015,qe=Math.max(5,Math.min(80,qe)))}let at=0;function ot(e){if(e.touches.length===2){let t=e.touches[0].clientX-e.touches[1].clientX,n=e.touches[0].clientY-e.touches[1].clientY;at=Math.sqrt(t*t+n*n)}}function st(e){if(e.touches.length===2){e.preventDefault();let t=e.touches[0].clientX-e.touches[1].clientX,n=e.touches[0].clientY-e.touches[1].clientY,r=Math.sqrt(t*t+n*n);qe-=(r-at)*.08,qe=Math.max(5,Math.min(80,qe)),at=r}}function ct(){let e=r.clientWidth,t=r.clientHeight;c.aspect=e/t,c.updateProjectionMatrix(),o.setSize(e,t)}n.addEventListener(`mousedown`,Ze),n.addEventListener(`click`,rt),window.addEventListener(`mouseup`,Qe),window.addEventListener(`mousemove`,$e),n.addEventListener(`wheel`,it,{passive:!1}),n.addEventListener(`touchstart`,et,{passive:!0}),n.addEventListener(`touchstart`,ot,{passive:!0}),n.addEventListener(`touchend`,tt,{passive:!0}),n.addEventListener(`touchmove`,nt,{passive:!1}),n.addEventListener(`touchmove`,st,{passive:!1}),window.addEventListener(`resize`,ct);let lt=new Ja,ut;function dt(){ut=requestAnimationFrame(dt);let e=lt.getElapsedTime();Ue+=(Ge-Ue)*Xe,We+=(Ke-We)*Xe,_.rotation.y=Ue,_.rotation.x=We;let t=qe,n=3.8+Math.max(0,We)*5.5,r=t*Math.cos(Math.max(0,-We)*.5);c.position.set(0,n,r),c.lookAt(0,1.25,0),T.position.x+=(Ee-T.position.x)*.04,Oe>0?(T.position.y=1.88+Math.sin(e*80)*Oe*.04,Oe*=.82,Oe<.005&&(Oe=0)):T.position.y=1.88,F?(I+=.016,te.opacity=Math.max(0,1-I),I>=1&&(F=!1,I=0,P=0,ne=0,te.opacity=1,Te=[``],R=0,Ee=2.2,z())):te.opacity=1,O.rotation.x+=4e-4,p.intensity=Math.sin(e*3.7)*.8+Math.sin(e*7.1)*.4+Math.cos(e*2.3)*.3+2.2,p.position.x=3+Math.sin(e*1.1)*.15,p.position.z=5+Math.cos(e*.9)*.1,f.intensity=3.5+Math.sin(e*1.3)*.4+Math.sin(e*2.9)*.2,l.intensity=600+Math.sin(e*.7)*18,Le||(Ge+=Math.sin(e*.09)*3e-4),o.render(s,c)}return dt(),()=>{cancelAnimationFrame(ut),window.removeEventListener(`keydown`,Ie),n.removeEventListener(`mousedown`,Ze),n.removeEventListener(`click`,rt),window.removeEventListener(`mouseup`,Qe),window.removeEventListener(`mousemove`,$e),n.removeEventListener(`wheel`,it),n.removeEventListener(`touchstart`,et),n.removeEventListener(`touchstart`,ot),n.removeEventListener(`touchend`,tt),n.removeEventListener(`touchmove`,nt),n.removeEventListener(`touchmove`,st),window.removeEventListener(`resize`,ct),o.dispose()}},[]),(0,y.jsx)(`canvas`,{ref:t,style:{display:`block`,width:`100%`,height:`100%`}})}function Cl(){let{t:e}=C(),t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(-1),i=(0,_.useRef)(0),a=(0,_.useRef)(0),o=(0,_.useRef)(null),s=(0,_.useRef)(e.machineParagraphs),[c,l]=(0,_.useState)(``),[u,d]=(0,_.useState)(1);(0,_.useEffect)(()=>{s.current=e.machineParagraphs,r.current=-1,a.current=0,i.current=0,l(``)},[e.machineParagraphs]);function f(e){o.current=null;let t=i.current-a.current;if(Math.abs(t)<.5){a.current=i.current,l(e.slice(0,Math.round(a.current)));return}a.current+=Math.sign(t)*pl(Math.abs(t)*.18,.4,12),l(e.slice(0,Math.round(a.current))),o.current=requestAnimationFrame(()=>f(e))}return(0,_.useEffect)(()=>{function e(){let e=s.current,n=t.current;if(!n)return;let c=n.getBoundingClientRect().top+window.scrollY,u=n.offsetHeight-window.innerHeight,p=pl((window.scrollY-c)/u,0,1),m=1/e.length,h=pl(Math.floor(p/m),0,e.length-1),g=(p-h*m)/m,_=e[h];if(h!==r.current&&(o.current&&=(cancelAnimationFrame(o.current),null),l(``),d(1),r.current=h,a.current=0,i.current=0),g>=1-fl&&h<e.length-1){d(pl(1-(g-(1-fl))/fl,0,1)),i.current=a.current=_.length,l(_);return}d(1),i.current=ml(pl(g/(1-fl),0,1))*_.length,o.current||=requestAnimationFrame(()=>f(_))}return window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),(0,y.jsx)(`div`,{id:`s-machine-rail`,ref:t,children:(0,y.jsxs)(`div`,{id:`s-machine-sticky`,children:[(0,y.jsx)(`div`,{className:`machine-text-zone`,children:(0,y.jsx)(`div`,{id:`machine-para`,style:{opacity:u},children:c})}),(0,y.jsx)(`div`,{className:`machine-3d`,ref:n,children:(0,y.jsx)(Sl,{containerRef:n})})]})})}var wl=`/t2-typewriter/assets/couv-DaKyX502.jpg`,Tl=`/t2-typewriter/assets/barrie-tullett-CbJMX4w5.png`,El=`/t2-typewriter/assets/keirathboneeye-OXQX3a2R.jpg`;function Dl(){let{t:e}=C(),t=(0,_.useRef)(e);(0,_.useEffect)(()=>{t.current=e},[e]);let n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(null),s=(0,_.useRef)(null),c=(0,_.useRef)(null),l=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let e=n.current;if(!e)return;let u=[r.current,i.current,a.current],d=o.current,f=s.current,p=c.current,m=l.current,h=u.length,g=0,_=!1,v=null,y=0,b=0;function x(){u.forEach((e,t)=>{e.style.zIndex=e.classList.contains(`flipped`)?t+1:h-t})}function S(){let e=g,n=t.current;f.classList.toggle(`open`,e>0),p.classList.toggle(`visible`,e>0),clearTimeout(v),e===0?(d.classList.remove(`visible`),d.style.background=``):(d.style.background=e===1?``:`#ffffff`,v=setTimeout(()=>{g>0&&d.classList.add(`visible`)},650)),m&&(e===0?m.textContent=n.livreCTA[0]:e<h?m.textContent=n.livreCTA[1]:m.textContent=n.livreCTA[2])}function C(){g>=h||(u[g].classList.add(`flipped`),g++,x(),S())}function w(){g<=0||(g--,u[g].classList.remove(`flipped`),x(),S())}function T(){_=!0;let e=h,t=e=>e.preventDefault();window.addEventListener(`wheel`,t,{passive:!1}),window.addEventListener(`touchmove`,t,{passive:!1});function n(){if(e<=0){u.forEach(e=>e.classList.remove(`fast`)),f.classList.remove(`open`,`closing`),p.classList.remove(`visible`),d.classList.remove(`visible`),g=0,y=0,_=!1,window.removeEventListener(`wheel`,t,{passive:!1}),window.removeEventListener(`touchmove`,t,{passive:!1}),window.removeEventListener(`wheel`,E,{passive:!1}),S(),window.addEventListener(`wheel`,E,{passive:!1});return}e--;let r=u[e];r.classList.add(`fast`),r.classList.remove(`flipped`),e===0&&(f.classList.add(`closing`),f.classList.remove(`open`),d.classList.remove(`visible`)),x(),setTimeout(()=>{r.classList.remove(`fast`),f.classList.remove(`closing`),n()},440)}n()}function E(t){let n=e.getBoundingClientRect();if(!(n.top<=0&&n.bottom>=window.innerHeight)||_)return;t.preventDefault();let r=t.deltaY>0?1:-1;r!==b&&(y=0,b=r),y+=t.deltaY,!(Math.abs(y)<80)&&(y=0,r>0?g<h?(_=!0,C(),setTimeout(()=>{_=!1},650)):T():g>0&&(_=!0,w(),setTimeout(()=>{_=!1},650)))}return window.addEventListener(`wheel`,E,{passive:!1}),x(),S(),()=>{window.removeEventListener(`wheel`,E,{passive:!1}),clearTimeout(v)}},[]),(0,y.jsx)(y.Fragment,{children:(0,y.jsx)(`div`,{id:`s-livre-rail`,ref:n,children:(0,y.jsxs)(`div`,{id:`s-livre-sticky`,children:[(0,y.jsxs)(`div`,{className:`lv-top`,children:[(0,y.jsx)(`p`,{className:`lv-cta`,ref:l,children:e.livreCTA[0]}),(0,y.jsxs)(`div`,{className:`lv-scene`,children:[(0,y.jsxs)(`div`,{className:`lv-book`,children:[(0,y.jsx)(`div`,{className:`lv-book-left`,ref:o}),(0,y.jsxs)(`div`,{className:`lv-book-right`,children:[(0,y.jsx)(`img`,{src:El,alt:`Keira Rathbone`,className:`lv-keira`}),(0,y.jsx)(`span`,{className:`lv-keira-label`,children:`by Keira Rathbone`})]}),(0,y.jsx)(`div`,{className:`lv-shadow`,ref:s}),(0,y.jsxs)(`div`,{className:`lv-page lv-paper`,ref:a,children:[(0,y.jsx)(`div`,{className:`lv-face lv-fp lv-fp-r lv-photo-face`,children:(0,y.jsx)(`img`,{src:Tl,alt:`Barrie Tullett`,className:`lv-barrie`})}),(0,y.jsx)(`div`,{className:`lv-face lv-back lv-fp lv-fp-l lv-text-face`,children:(0,y.jsx)(`p`,{className:`lv-body-text`,children:e.livreAnthologie})})]}),(0,y.jsxs)(`div`,{className:`lv-page lv-paper`,ref:i,children:[(0,y.jsxs)(`div`,{className:`lv-face lv-fp lv-fp-r lv-title-face`,children:[(0,y.jsxs)(`span`,{className:`lv-title`,children:[`Typewriter Art`,(0,y.jsx)(`span`,{className:`lv-subtitle`,children:`A Modern Anthology`})]}),(0,y.jsx)(`div`,{className:`lv-rule`}),(0,y.jsx)(`span`,{className:`lv-author`,children:`Barrie Tullett`})]}),(0,y.jsx)(`div`,{className:`lv-face lv-back lv-fp lv-fp-l lv-text-face`,children:(0,y.jsx)(`p`,{className:`lv-body-text`,children:e.livreBarrie})})]}),(0,y.jsxs)(`div`,{className:`lv-page`,ref:r,children:[(0,y.jsx)(`div`,{className:`lv-face lv-cover-front`,style:{backgroundImage:`url(${wl})`}}),(0,y.jsx)(`div`,{className:`lv-face lv-back lv-cover-back`})]})]}),(0,y.jsx)(`div`,{className:`lv-spine`,ref:c})]})]}),(0,y.jsx)(`div`,{className:`lv-bot`,children:(0,y.jsxs)(`blockquote`,{className:`livre-quote`,children:[e.livreQuote,(0,y.jsx)(`cite`,{children:e.livreQuoteCite})]})})]})})})}var Ol=`      ..                             .                        
x .d88"                    oec :    @88>                      
 5888R                    @88888    %8P      u.    u.         
...
'8888c. .+  "*88*" 8888" .888N..888   .@8c 
 "88888%      ""   'Y"    \`"888*""   '%888"
   "YP'                      ""        ^*  `,Al={fr:{readArticle:`Lire l'article`,buyBook:`Acheter le livre`,articleSite:`The Marginalian`,articleDesc:`L'histoire complète de l'anthologie racontée par Maria Popova`,bookTitle:`Typewriter Art\xA0: A Modern Anthology`,bookSub:`Barrie Tullett — Laurence King Publishing`,credit:`130 ans de caractères frappés.`},en:{readArticle:`Read the article`,buyBook:`Buy the book`,articleSite:`The Marginalian`,articleDesc:`The full story of the anthology told by Maria Popova`,bookTitle:`Typewriter Art: A Modern Anthology`,bookSub:`Barrie Tullett — Laurence King Publishing`,credit:`130 years of struck characters.`}},jl=`─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · ─ · `;function Ml({onScrollBack:e}){let{lang:t}=C(),n=Al[t],r=t===`fr`?Ol:kl,i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(!1),s=(0,_.useRef)(0);return(0,_.useEffect)(()=>{let e=a.current;if(!e)return;let t=0,n;function r(){t-=.5;let i=e.scrollWidth/2;Math.abs(t)>=i&&(t=0),e.style.transform=`translateX(${t}px)`,n=requestAnimationFrame(r)}return n=requestAnimationFrame(r),()=>cancelAnimationFrame(n)},[]),(0,_.useEffect)(()=>{function t(){o.current&&window.scrollTo(0,s.current)}let n=null;function r(t){if(!o.current)return;t.preventDefault(),t.stopPropagation();let r=t.deltaY;t.deltaMode===1&&(r*=24),t.deltaMode===2&&(r*=window.innerHeight),!(n||Math.abs(r)<10)&&(r<0&&(o.current=!1,e?.(),n=setTimeout(()=>{n=null},1e3)),n=setTimeout(()=>{n=null},600))}let i=0;function a(e){o.current&&(i=e.touches[0].clientY)}function c(t){if(!o.current)return;t.preventDefault();let n=i-t.touches[0].clientY;Math.abs(n)>50&&n<0&&(o.current=!1,e?.())}return window.addEventListener(`scroll`,t,{passive:!1}),window.addEventListener(`wheel`,r,{passive:!1}),window.addEventListener(`touchstart`,a,{passive:!0}),window.addEventListener(`touchmove`,c,{passive:!1}),()=>{window.removeEventListener(`scroll`,t),window.removeEventListener(`wheel`,r),window.removeEventListener(`touchstart`,a),window.removeEventListener(`touchmove`,c)}},[e]),(0,_.useEffect)(()=>{let e=i.current;if(!e)return;let t=new IntersectionObserver(([t])=>{t.isIntersecting?(s.current=e.offsetTop,window.scrollTo(0,s.current),o.current=!0):o.current=!1},{threshold:.5});return t.observe(e),()=>t.disconnect()},[]),(0,y.jsxs)(`footer`,{id:`s-footer`,ref:i,children:[(0,y.jsx)(`div`,{className:`footer-the-end`,"aria-label":t===`fr`?`La Fin`:`The End`,children:(0,y.jsx)(`pre`,{className:`footer-the-end-ascii`,children:r})}),(0,y.jsx)(`div`,{className:`footer-ribbon-wrap`,"aria-hidden":`true`,children:(0,y.jsx)(`div`,{ref:a,className:`footer-ribbon`,children:jl.repeat(8)})}),(0,y.jsxs)(`div`,{className:`footer-inner`,children:[(0,y.jsxs)(`a`,{href:`https://www.themarginalian.org/2014/05/23/typewriter-art-laurence-king/`,target:`_blank`,rel:`noopener noreferrer`,className:`footer-card`,children:[(0,y.jsx)(`span`,{className:`footer-card-label`,children:n.readArticle}),(0,y.jsx)(`span`,{className:`footer-card-site`,children:n.articleSite}),(0,y.jsx)(`span`,{className:`footer-card-desc`,children:n.articleDesc}),(0,y.jsx)(`span`,{className:`footer-card-arrow`,children:`↗`})]}),(0,y.jsx)(`div`,{className:`footer-sep`,"aria-hidden":`true`,children:Array.from({length:10}).map((e,t)=>(0,y.jsx)(`span`,{children:`│`},t))}),(0,y.jsxs)(`a`,{href:`https://www.amazon.fr/dp/1780673477?linkCode=gg2&tag=braipick-20`,target:`_blank`,rel:`noopener noreferrer`,className:`footer-card`,children:[(0,y.jsx)(`span`,{className:`footer-card-label`,children:n.buyBook}),(0,y.jsx)(`span`,{className:`footer-card-site`,children:`Amazon.fr`}),(0,y.jsx)(`span`,{className:`footer-card-desc footer-card-desc--italic`,children:n.bookTitle}),(0,y.jsx)(`span`,{className:`footer-card-sub`,children:n.bookSub}),(0,y.jsx)(`span`,{className:`footer-card-arrow`,children:`↗`})]})]}),(0,y.jsx)(`div`,{className:`footer-bottom`,children:(0,y.jsx)(`span`,{className:`footer-credit`,children:n.credit})})]})}function Nl(){let[e,t]=(0,_.useState)(-12),n=(0,_.useRef)(!1),r=(0,_.useRef)(null);function i(e,t,n){return Math.max(t,Math.min(n,e))}function a(e){let t=r.current;if(!t)return 0;let{left:n,width:a}=t.getBoundingClientRect();return i((e-n)/a,0,1)}function o(e){let t=document.documentElement.scrollHeight-window.innerHeight;window.scrollTo({top:e*t})}function s(){if(n.current)return;let e=document.documentElement.scrollHeight-window.innerHeight,a=e>0?i(window.scrollY/e,0,1):0,o=r.current;o&&t(a*(o.offsetWidth-24))}(0,_.useEffect)(()=>(window.addEventListener(`scroll`,s,{passive:!0}),window.addEventListener(`resize`,s),()=>{window.removeEventListener(`scroll`,s),window.removeEventListener(`resize`,s)}),[]);function c(e){e.preventDefault(),n.current=!0,window.__rollerDragging=!0;let i=e=>{let n=a(e.clientX),i=r.current;i&&t(n*(i.offsetWidth-24)),o(n)},s=()=>{n.current=!1,window.__rollerDragging=!1,window.removeEventListener(`mousemove`,i),window.removeEventListener(`mouseup`,s)};window.addEventListener(`mousemove`,i),window.addEventListener(`mouseup`,s)}function l(){n.current=!0,window.__rollerDragging=!0;let e=e=>{let n=a(e.touches[0].clientX),i=r.current;i&&t(n*(i.offsetWidth-24)),o(n)},i=()=>{n.current=!1,window.__rollerDragging=!1,window.removeEventListener(`touchmove`,e),window.removeEventListener(`touchend`,i)};window.addEventListener(`touchmove`,e,{passive:!0}),window.addEventListener(`touchend`,i)}function u(e){if(e.target!==e.currentTarget)return;let n=a(e.clientX),i=r.current;i&&t(n*(i.offsetWidth-24)),o(n)}return(0,y.jsx)(`div`,{id:`roller`,ref:r,onClick:u,children:(0,y.jsx)(`div`,{id:`roller-ball`,style:{left:e+`px`},onMouseDown:c,onTouchStart:l})})}function Pl(e){return(0,y.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`1em`,height:`1em`,viewBox:`0 0 24 24`,...e,children:(0,y.jsx)(`path`,{fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,d:`M1 12h3m16 0h3M2 22h20v-3l-2.5-9h-5v2h-5v-2h-5L2 19zM6 7V2h12v5M5.5 17h3m2 0h3m2 0h3`})})}function Fl(e){return(0,y.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`1em`,height:`1em`,viewBox:`0 0 14 14`,...e,children:(0,y.jsxs)(`g`,{fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,children:[(0,y.jsx)(`path`,{d:`m3.5 1.5l-3 3l3 3`}),(0,y.jsx)(`path`,{d:`M.5 4.5h9a4 4 0 0 1 0 8h-5`})]})})}function Z(e){return(0,y.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`1em`,height:`1em`,viewBox:`0 0 512 512`,...e,children:[(0,y.jsx)(`path`,{fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`32`,d:`M48 112h288M192 64v48m80 336l96-224l96 224m-162.5-64h133M281.3 112S257 206 199 277S80 384 80 384`}),(0,y.jsx)(`path`,{fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`32`,d:`M256 336s-35-27-72-75s-56-85-56-85`})]})}var Q={I:{era:0,oeuvre:0},II:{era:0,oeuvre:1},III:{era:0,oeuvre:2},IV:{era:0,oeuvre:3},V:{era:1,oeuvre:0},VI:{era:1,oeuvre:1},VII:{era:1,oeuvre:2},VIII:{era:1,oeuvre:3},IX:{era:1,oeuvre:4},X:{era:1,oeuvre:5},XI:{era:2,oeuvre:0},XII:{era:3,oeuvre:0},XIII:{era:3,oeuvre:1},XIV:{era:3,oeuvre:2},XV:{era:3,oeuvre:3}},Il=[[`__PRINTER__`,`I`,`II`,`III`,`IV`,`__LANG__`],[`V`,`VI`,`VII`,`VIII`,`IX`,`X`,`XI`],[`__TOGGLE__`,`XII`,`XIII`,`XIV`,`XV`,`__BACK__`]];function Ll(e,t,n){return Math.max(t,Math.min(n,e))}function Rl(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}function zl({navigateTo:e}){let[t,n]=(0,_.useState)(!1),r=(0,_.useRef)(null),i=(0,_.useRef)({}),a=(0,_.useRef)(!1);function o(){let e=r.current;if(!e)return{};Object.values(i.current).forEach(e=>{e&&(e.style.transform=`none`,e.style.opacity=``)});let t=e.getBoundingClientRect(),n=t.left+t.width/2,a=t.top+t.height/2,o={};return Object.entries(i.current).forEach(([e,t])=>{if(!t)return;let r=t.getBoundingClientRect();o[e]={dx:n-(r.left+r.width/2),dy:a-(r.top+r.height/2)}}),o}function s(e){if(a.current)return;a.current=!0;let t=o(),r=Object.keys(i.current);e||r.forEach(e=>{let n=i.current[e],r=t[e];!n||!r||(n.style.transform=`translate(${r.dx}px, ${r.dy}px)`,n.style.opacity=`0`)});let s=r.length,c=performance.now();function l(o){let u=Math.min(1,(o-c)/480);r.forEach((n,r)=>{let a=i.current[n],o=t[n];if(!a||!o)return;let c=e?r/s*.3:(s-1-r)/s*.3,l=e?Rl(Ll((u-c)/(1-c),0,1)):1-Rl(Ll((u-c)/(1-c),0,1));a.style.transform=`translate(${o.dx*l}px, ${o.dy*l}px)`,a.style.opacity=String(1-l)}),u<1?requestAnimationFrame(l):(r.forEach(n=>{let r=i.current[n],a=t[n];!r||!a||(r.style.transform=e?`translate(${a.dx}px, ${a.dy}px)`:``,r.style.opacity=e?`0`:``)}),n(e),a.current=!1)}requestAnimationFrame(l)}function c(t){if(Q[t]){let{era:n,oeuvre:r}=Q[t];e?.(n,r)}else t===`__PRINTER__`?e?.(`machine`):t===`__BACK__`?e?.(`__back__`):t===`__LANG__`&&e?.(`toggleLang`)}function l(){a.current||s(!t)}return(0,y.jsx)(`div`,{className:`keyboard`,children:Il.map((e,n)=>(0,y.jsx)(`div`,{className:`key-row`,children:e.map(e=>e===`__TOGGLE__`?(0,y.jsxs)(`div`,{className:`key-wrap key-toggle`,ref:r,onClick:l,children:[(0,y.jsx)(`div`,{className:`key`,children:(0,y.jsx)(`span`,{children:t?`+`:`×`})}),(0,y.jsx)(`div`,{className:`key-tige`})]},`toggle`):(0,y.jsxs)(`div`,{className:`key-wrap`,ref:t=>{i.current[e]=t},style:{willChange:`transform, opacity`},onClick:()=>c(e),children:[(0,y.jsx)(`div`,{className:`key`,children:(0,y.jsx)(`span`,{children:e===`__PRINTER__`?(0,y.jsx)(Pl,{style:{fontSize:`1.2em`}}):e===`__BACK__`?(0,y.jsx)(Fl,{style:{fontSize:`1.1em`}}):e===`__LANG__`?(0,y.jsx)(Z,{style:{fontSize:`1.2em`}}):e})}),(0,y.jsx)(`div`,{className:`key-tige`})]},e))},n))})}function Bl(){let[e,t]=(0,_.useState)(!0);return(0,_.useEffect)(()=>{function e(){let e=document.elementFromPoint(window.innerWidth/2,window.innerHeight/2);if(!e)return;let n=e;for(;n&&n!==document.body;){let e=window.getComputedStyle(n).backgroundColor;if(e&&e!==`rgba(0, 0, 0, 0)`&&e!==`transparent`){let n=e.match(/\d+/g);if(n){let[e,r,i]=n.map(Number);t(.299*e+.587*r+.114*i<140);return}}n=n.parentElement}}return e(),window.addEventListener(`scroll`,e,{passive:!0}),()=>window.removeEventListener(`scroll`,e)},[]),e}function Vl(){let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!1),i=(0,_.useRef)(null),a=Bl();(0,_.useEffect)(()=>{let e=document.getElementById(`s-footer`);if(!e)return;let t=new IntersectionObserver(([e])=>{r(e.isIntersecting)},{threshold:.1});return t.observe(e),()=>t.disconnect()},[]);function o(){t(!1),clearTimeout(i.current),i.current=setTimeout(()=>t(!0),4e3)}(0,_.useEffect)(()=>(o(),window.addEventListener(`scroll`,o,{passive:!0}),window.addEventListener(`touchstart`,o,{passive:!0}),window.addEventListener(`click`,o,{passive:!0}),()=>{clearTimeout(i.current),window.removeEventListener(`scroll`,o),window.removeEventListener(`touchstart`,o),window.removeEventListener(`click`,o)}),[]);let s=a?`rgba(255, 251, 232, 0.75)`:`rgba(17, 17, 17, 0.65)`;return(0,y.jsxs)(`div`,{id:`scroll-hint`,className:e&&!n?`visible`:``,style:{"--hint-color":s},children:[(0,y.jsx)(`span`,{className:`hint-label`,children:`scroll`}),(0,y.jsx)(`span`,{className:`hint-arrow`,children:`↓`})]})}var Hl=`/t2-typewriter/assets/queenvictoria-D0V_kXO4.webp`,Ul=`/t2-typewriter/assets/whisperpiece-DU4O-Hen.webp`,Wl=`/t2-typewriter/assets/beethoventoday-d5OIGxMq.webp`,Gl=`/t2-typewriter/assets/carnival-nstQ_Ur4.webp`,Kl=`/t2-typewriter/assets/textum2-CO2AAewz.webp`,ql=`/t2-typewriter/assets/the-words-we-use-are-lovely-CEavljZl.webp`,Jl=`/t2-typewriter/assets/O-CXIR-m7r.webp`,Yl=`/t2-typewriter/assets/unusual-love-poem-BArBRaMc.webp`,Xl=`/t2-typewriter/assets/typewritten-portraits-BY18fQse.webp`,Zl=`/t2-typewriter/assets/lookingforward-DGiKwCYK.webp`,Ql=`/t2-typewriter/assets/the-pattern-serie-DzEIQILV.webp`,$l=`/t2-typewriter/assets/barcelona-love-letters-KJA0vQYC.webp`,eu=`/t2-typewriter/assets/alan-riddell-DSD5x-xW.png`,tu=`/t2-typewriter/assets/bob-cobbing-ciGAQWJS.png`,nu=`/t2-typewriter/assets/steve-mccaffery-DNTSUtin.png`,ru=`/t2-typewriter/assets/vicki-simpson-DU3qnK0g.png`,iu=`/t2-typewriter/assets/miroljub-todorovic-CV7h2hcl.png`,au=`/t2-typewriter/assets/keira-rathbone-BO92Jcmx.png`,ou=`/t2-typewriter/assets/typewritersmanual-SdMSkgF9.webp`,su=`/t2-typewriter/assets/isaac-pitman-BmO1iMw4.png`,cu=`/t2-typewriter/assets/untitledflora-CmitKqF6.webp`,lu=`/t2-typewriter/assets/ottovonbismarck-lBaDGBIj.webp`;function uu(e){return new Promise(t=>setTimeout(t,e))}function du(e){return Math.max(16,e+(Math.random()-.5)*12)}function fu(e,t){let[n,r]=(0,_.useState)(Array(e.length).fill(``)),i=(0,_.useRef)(!1);return(0,_.useEffect)(()=>{if(!t)return;i.current=!1,r(Array(e.length).fill(``));function n(e,t,n,a){let o=0;setTimeout(function n(){i.current||(o<t.length?(r(n=>{let r=[...n];return r[e]=t.slice(0,o+1),r}),o++,setTimeout(n,80)):a&&setTimeout(a,200))},n)}return n(0,e[0],400,()=>n(1,e[1],0,()=>n(2,e[2],0,null))),()=>{i.current=!0}},[t]),n}function pu(e,t,n){let[r,i]=(0,_.useState)([]),[a,o]=(0,_.useState)([]),s=(0,_.useRef)(!1);return(0,_.useEffect)(()=>{if(!n)return;s.current=!1,i([]),o([]);async function r(e,t){let n=0;for(let r of e){if(s.current)return;let e=n++,i=r.bold?`bold`:r.italic?`italic`:`normal`;t(t=>[...t,{id:e,style:i,content:``}]);for(let n of r.text){if(s.current)return;t(t=>t.map(t=>t.id===e?{...t,content:t.content+n}:t)),await uu(du(44))}}}async function a(){await r(e,i),!s.current&&(await uu(350),await r(t,o))}return a(),()=>{s.current=!0}},[n]),[r,a]}function mu(e){return e.style===`bold`?(0,y.jsx)(`strong`,{children:e.content},e.id):e.style===`italic`?(0,y.jsx)(`em`,{children:e.content},e.id):(0,y.jsx)(`span`,{children:e.content},e.id)}function hu({lines:e,p1:t,p2:n,totalChars:r,imageOeuvre:i,imageBg:a,progress:o,canStart:s,autoMode:c=!1,bgColor:l=`#fafafa`}){let[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(!1),m=(0,_.useRef)(!1);(0,_.useEffect)(()=>{if(s&&!m.current)if(c)p(!0);else{p(!1);let e=setTimeout(()=>p(!0),50);return()=>clearTimeout(e)}!s&&m.current&&(p(!1),d(!1),setShowArtist(!1)),m.current=s},[s,c]),(0,_.useEffect)(()=>{o>.4&&!u&&!c&&d(!0),o<=.1&&u&&d(!1)},[o,c]);let[h,g,v]=fu(e,s),[b,x]=pu(t,n,u),S=c?1:Math.max(0,1-(o-.3)/.15),C=c?0:Math.min(1,Math.max(0,(o-.4)/.15));return(0,y.jsxs)(`div`,{className:`ov2-panel`,style:{background:l},children:[(0,y.jsx)(`div`,{className:`ov2-bg`,children:(0,y.jsx)(`img`,{src:a||i,alt:``})}),(0,y.jsxs)(`header`,{className:`ov2-header`,children:[(0,y.jsx)(`div`,{className:`ov2-title-italic`,children:h}),(0,y.jsxs)(`div`,{className:`ov2-title-sub`,children:[g,` `,v]})]}),(0,y.jsxs)(`div`,{className:`ov2-content`,children:[s&&(0,y.jsx)(`div`,{className:`ov2-image${f?` ov2-image--visible`:``}`,style:{opacity:S,pointerEvents:S<.1?`none`:`auto`},children:(0,y.jsx)(`img`,{src:i,alt:e[0]})}),(0,y.jsxs)(`div`,{className:`ov2-desc`,style:{opacity:C,pointerEvents:C<.1?`none`:`auto`},children:[(0,y.jsx)(`p`,{className:`ov2-para`,children:b.map(mu)}),x.length>0&&(0,y.jsx)(`p`,{className:`ov2-para`,children:x.map(mu)})]})]})]})}function gu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#edeae0`,imageOeuvre:Hl,imageBg:Hl,totalChars:490,lines:[`‘Queen Victoria’`,`unknown artist`,`(c. 1898)`],p1:[{text:`Queen Victoria`},{text:` (`},{text:`1819–1901`,bold:!0},{text:`) reigned for 63 years, making her the `},{text:`longest-reigning British monarch`,italic:!0},{text:` of the 19th century. This typewritten portrait was likely produced by an anonymous typist in `},{text:`celebration`,bold:!0},{text:` of her Diamond Jubilee.`}],p2:[{text:`Executed with remarkable skill, the portrait captures Victoria’s `},{text:`iconic profile`,italic:!0},{text:` using only the characters of a standard typewriter. The work stands as a testament to the `},{text:`technical virtuosity`,bold:!0},{text:` of early operators.`}]})}function _u({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#e8e8e8`,imageOeuvre:Ul,imageBg:tu,totalChars:480,lines:[`‘Whisper Piece’`,`by Bob Cobbing`,`(1970)`],p1:[{text:`Bob Cobbing`},{text:` (`},{text:`1920–2002`,bold:!0},{text:`) was a British `},{text:`sound poet and visual artist`,italic:!0},{text:` who used the typewriter, photocopier and duplicating machines to create dense typographic textures. His work operates as `},{text:`scores for performance`,bold:!0},{text:`.`}],p2:[{text:`‘Whisper Piece’ is a visual-sound poem where typewritten characters are arranged in patterns evoking the `},{text:`act of whispering`,italic:!0},{text:` — breath, silence and intimacy. The `},{text:`typographic composition`,bold:!0},{text:` mimics sound through visual density.`}]})}function vu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#e8e8e8`,imageOeuvre:Wl,imageBg:tu,totalChars:500,lines:[`‘Beethoven Today’`,`by Bob Cobbing`,`(1967)`],p1:[{text:`Bob Cobbing`},{text:` (`},{text:`1920–2002`,bold:!0},{text:`) was a British `},{text:`sound poet and visual artist`,italic:!0},{text:` who pushed the boundaries of language beyond meaning. He used the typewriter, photocopier, and `},{text:`duplicating machines`,bold:!0},{text:` to create dense typographic textures operating as scores for performance.`}],p2:[{text:`‘Beethoven Today’ is a circular composition on `},{text:`yellow paper`,italic:!0},{text:`, where layers of text accumulate into an `},{text:`almost musical mass`,bold:!0},{text:` of marks, evoking both orchestral density and the limits of the printed page.`}]})}function yu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#e5e5e5`,imageOeuvre:Gl,imageBg:nu,totalChars:470,lines:[`Panel from ‘Carnival’`,`by Steve McCaffery`,`(1967–75)`],p1:[{text:`Steve McCaffery`},{text:` (b. `},{text:`1947`,bold:!0},{text:`) is a British-Canadian `},{text:`language poet`,italic:!0},{text:` whose work investigates the materiality of language. His `},{text:`Carnival`,bold:!0},{text:` is a major work of typewriter poetry.`}],p2:[{text:`Composed over eight years, `},{text:`Carnival`,italic:!0},{text:` consists of 16 perforated panels that can be dismantled and reassembled. Each panel is a dense `},{text:`visual poem`,bold:!0},{text:` produced on a typewriter, challenging the linearity of reading.`}]})}function bu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#e8e8e8`,imageOeuvre:Kl,imageBg:iu,totalChars:440,lines:[`‘Textum 2’`,`by Miroljub Todorovič`,`(1973)`],p1:[{text:`Miroljub Todorovič`},{text:` (b. `},{text:`1940`,bold:!0},{text:`) is a Serbian poet and founder of `},{text:`Signalism`,italic:!0},{text:`, a Yugoslav neo-avant-garde movement combining typewriter art, concrete poetry and visual language.`}],p2:[{text:`‘Textum 2’ is a composition produced on an `},{text:`Olivetti Lettera 32`,italic:!0},{text:`, using overlapping characters in red and black to create a `},{text:`woven textile effect`,bold:!0},{text:`. The title itself refers to the Latin for “woven”.`}]})}function xu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#f5f2ec`,imageOeuvre:ql,imageBg:ql,totalChars:460,lines:[`‘the words we use are lovely’`,`by J.P. Ward`,`(1973)`],p1:[{text:`J.P. Ward is a poet whose work explores the `},{text:`visual and sonic dimensions`,italic:!0},{text:` of language. This piece bridges `},{text:`concrete poetry`,bold:!0},{text:` and visual art, using the typewriter to create a composition both textual and pictorial.`}],p2:[{text:`This spiral composition radiates outward from a `},{text:`typographic centre`,bold:!0},{text:`, with words in rotating rays. The repetition creates a `},{text:`meditative rhythm`,italic:!0},{text:` that transforms reading into an almost visual experience.`}]})}function Su({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#e8e8e8`,imageOeuvre:Jl,imageBg:eu,totalChars:480,lines:[`‘O’`,`by Alan Riddell`,`(1975–1976)`],p1:[{text:`Alan Riddell`},{text:` (`},{text:`1927–1977`,bold:!0},{text:`) was a Scottish poet and key figure in `},{text:`concrete poetry`,italic:!0},{text:`, a movement exploring the visual dimensions of language. He used the typewriter as both tool and medium, where `},{text:`form becomes content`,bold:!0},{text:`.`}],p2:[{text:`‘O’ is one of Riddell’s most celebrated works — a `},{text:`geometric typewriter composition`,bold:!0},{text:` built from overlapping coloured ribbons forming a diamond of concentric frames. The work bridges `},{text:`Op Art and concrete poetry`,italic:!0},{text:`.`}]})}function Cu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#f5f2ec`,imageOeuvre:Yl,imageBg:eu,totalChars:420,lines:[`‘Unusual Love Poem’`,`by Alan Riddell`,`(1975)`],p1:[{text:`Dans cette oeuvre, Alan Riddell utilise le `},{text:`contour de deux bouteilles`,italic:!0},{text:` construit entièrement de caractères typographiques répétés. Les étiquettes — “bottle of love” et “bottle of kisses” — sont inscrites en `},{text:`type monospace`,bold:!0},{text:`.`}],p2:[{text:`La pièce appartient aux `},{text:`shaped poems`,italic:!0},{text:` de Riddell, où la forme visuelle et le contenu verbal sont inséparables. La machine à écrire devient un moyen de `},{text:`dessiner avec des mots`,bold:!0},{text:`.`}]})}function wu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#f2f0ea`,imageOeuvre:Xl,imageBg:Xl,totalChars:450,lines:[`from ‘Typewritten Portraits’`,`by Nadine Faye James`,`(2007)`],p1:[{text:`Nadine Faye James creates `},{text:`intimate portraits`,bold:!0},{text:` of friends and family using only the characters of a vintage typewriter, capturing personality through `},{text:`typographic texture`,italic:!0},{text:`.`}],p2:[{text:`The series demonstrates the enduring appeal of `},{text:`analogue processes`,bold:!0},{text:` in the digital age, and the unique warmth that the typewriter brings to portrait art.`}]})}function Tu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#ede8e0`,imageOeuvre:Zl,imageBg:au,totalChars:490,lines:[`‘Looking Forward’`,`by Keira Rathbone`,`(2010)`],p1:[{text:`Keira Rathbone`},{text:` (née en `},{text:`1981`,bold:!0},{text:`) est une artiste britannique qui crée des `},{text:`portraits à la machine à écrire`,italic:!0},{text:` d’une précision extraordinaire, repoussant les limites entre `},{text:`dessin et frappe`,bold:!0},{text:`.`}],p2:[{text:`‘Looking Forward’ est un portrait où le texte du 19e amendement de la Constitution américaine est entièrement tapé, fusionnant `},{text:`contenu politique`,bold:!0},{text:` et forme visuelle en une déclaration sur les droits et la représentation.`}]})}function Eu({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#f5f2ec`,imageOeuvre:Ql,imageBg:ru,totalChars:400,lines:[`‘The Pattern Series’`,`by Vickie Simpson`,`(2012)`],p1:[{text:`Dans cette série, Vickie Simpson abandonne la représentation au profit de la `},{text:`pure abstraction géométrique`,bold:!0},{text:`, créant des compositions en losange avec des rubans de machine à écrire colorés. Le résultat est une `},{text:`surface textile`,italic:!0},{text:` de caractères entrelacés.`}],p2:[{text:`La série s’inspire de l’`},{text:`Op Art et du tissage`,italic:!0},{text:`, utilisant la grille de la machine pour générer des `},{text:`rythmes optiques`,bold:!0},{text:` qui vibrent sur la page.`}]})}function Du({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#f0ede5`,imageOeuvre:$l,imageBg:au,totalChars:460,lines:[`‘Barcelona Love Letters’`,`by Keira Rathbone`,`(2002)`],p1:[{text:`Keira Rathbone a créé cette oeuvre lors d’une résidence à `},{text:`Barcelone`,bold:!0},{text:`. À l’aide de sa machine à écrire, elle a dessiné de petites `},{text:`figures humaines`,italic:!0},{text:` dispersées sur la page, chacune composée de frappes individuelles. L’oeuvre capture la `},{text:`chorégraphie de la vie urbaine`,bold:!0},{text:`.`}],p2:[{text:`Datée du `},{text:`27/4/2002`,italic:!0},{text:`, elle appartient aux “love letters” de Rathbone — dessins d’observation d’espaces publics faits à la machine à écrire plutôt qu’au crayon. Le résultat est à la fois `},{text:`document et poème`,bold:!0},{text:`.`}]})}function Ou({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#f5f0e8`,imageOeuvre:ou,imageBg:su,totalChars:467,lines:[`Pitman’s Typewriter Manual`,`by Isaac Pitman`,`(1893)`],p1:[{text:`Isaac Pitman`},{text:` (`},{text:`1813–1897`,bold:!0},{text:`) was a `},{text:`British educator`,italic:!0},{text:` who invented in 1837 a system of `},{text:`stenography`,bold:!0},{text:` — allowing one to write at great speed. His method was widely adopted in offices throughout the `},{text:`19ᵗʰ century`,italic:!0},{text:` to take notes rapidly.`}],p2:[{text:`The first edition of `},{text:`Pitman’s Typewriter Manual`,italic:!0},{text:`, published in `},{text:`1893`,bold:!0},{text:`, included several examples of `},{text:`typed ornaments`,bold:!0},{text:` that a typewriter operator could use to `},{text:`embellish`,italic:!0},{text:` his or her work.`}]})}function ku({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#edeae0`,imageOeuvre:cu,imageBg:cu,totalChars:566,lines:[`‘Untitled’`,`by Flora F.F. Stacey`,`(1898)`],p1:[{text:`Flora F.F. Stacey`},{text:` was a `},{text:`British typewriter operator`,italic:!0},{text:` and amateur artist working in `},{text:`London`,bold:!0},{text:` at the turn of the century. She left behind a remarkable body of `},{text:`typewritten images`,bold:!0},{text:` produced entirely with the keys of a standard `},{text:`Remington typewriter`,italic:!0},{text:`.`}],p2:[{text:`Her untitled work of `},{text:`1898`,bold:!0},{text:` is considered one of the earliest known examples of `},{text:`typewriter art`,italic:!0},{text:`. It represents a female portrait built up line by line using overstriking — a technique demanding extraordinary `},{text:`patience`,italic:!0},{text:` and precision.`}]})}function Au({progress:e=0,canStart:t=!1,autoMode:n=!1}){return(0,y.jsx)(hu,{progress:e,canStart:t,autoMode:n,bgColor:`#ede8dc`,imageOeuvre:lu,imageBg:lu,totalChars:538,lines:[`‘Otto von Bismarck’`,`unknown artist`,`(1898)`],p1:[{text:`Otto von Bismarck`},{text:` (`},{text:`1815–1898`,bold:!0},{text:`) was the `},{text:`first Chancellor of the German Empire`,italic:!0},{text:`, a dominant figure of 19th-century European politics. This anonymous portrait, composed entirely of `},{text:`typewritten characters`,bold:!0},{text:`, was created in the year of his death.`}],p2:[{text:`The work exemplifies the `},{text:`pictorial ambition`,bold:!0},{text:` of early typewriter artists, who sought to reproduce recognizable faces through the patient accumulation of `},{text:`typographic marks`,italic:!0},{text:`. The density of characters reveals a mastery of the medium rarely seen at this period.`}]})}var ju=`      oe       u+=~~~+u.                       .n~~%x.    
...
88888888
88888888
`;function zu({animated:e,zoomOut:t,children:n}){let r=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let n=r.current;if(!n)return;if(!e){n.style.animation=`none`,n.style.opacity=`0`;return}n.style.animation=`none`,n.style.opacity=`0`,n.offsetWidth;let i=t?`dateZoomOut 0.9s cubic-bezier(0.25,0.46,0.45,0.94) both`:`dateZoomIn 0.65s cubic-bezier(0.34,1.56,0.64,1) both`;n.style.animation=i,n.style.opacity=``},[e,t]),(0,y.jsx)(`div`,{className:`era-date-panel`,children:(0,y.jsx)(`div`,{ref:r,className:`date-stack`,style:{opacity:0},children:n})})}function Bu({animated:e,zoomOut:t}){return(0,y.jsxs)(zu,{animated:e,zoomOut:t,children:[(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:ju}),(0,y.jsx)(`pre`,{className:`date-ascii-dash`,children:Ru}),(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Mu})]})}function Vu({animated:e,zoomOut:t}){return(0,y.jsxs)(zu,{animated:e,zoomOut:t,children:[(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Nu}),(0,y.jsx)(`pre`,{className:`date-ascii-dash`,children:Ru}),(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Pu})]})}function Hu({animated:e,zoomOut:t}){return(0,y.jsx)(zu,{animated:e,zoomOut:t,children:(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Fu})})}function Uu({animated:e,zoomOut:t}){return(0,y.jsxs)(zu,{animated:e,zoomOut:t,children:[(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Iu}),(0,y.jsx)(`pre`,{className:`date-ascii-dash`,children:Ru}),(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Lu})]})}function Wu(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}function Gu(e){return 1-(1-e)**3}var Ku=2e3;function qu(){let e=(0,_.useRef)(!1),t=(0,_.useRef)(0);function n(){if(e.current)return;e.current=!0,t.current=window.scrollY;function n(){window.scrollTo(0,t.current)}window.addEventListener(`scroll`,n,{passive:!1}),setTimeout(()=>{window.removeEventListener(`scroll`,n),e.current=!1},Ku)}return n}function Ju(e,t){let n=(0,_.useRef)(!1);(0,_.useEffect)(()=>{let r=e.current;if(!r)return;let i=new IntersectionObserver(([e])=>{e.isIntersecting&&!n.current&&(n.current=!0,t())},{threshold:1});return i.observe(r),()=>i.disconnect()},[])}var Yu=[{DatePanel:Bu,oeuvres:[{Component:Ou},{Component:ku},{Component:Au},{Component:gu}]},{DatePanel:Vu,oeuvres:[{Component:_u},{Component:vu},{Component:yu},{Component:bu},{Component:xu},{Component:Su}]},{DatePanel:Hu,oeuvres:[{Component:Cu}]},{DatePanel:Uu,oeuvres:[{Component:wu},{Component:Tu},{Component:Eu},{Component:Du}]}];function Xu({nextSectionRef:e,onRegisterJump:t,onRegisterReactivate:n}){let[r,i]=(0,_.useState)(0),[a,o]=(0,_.useState)(!1),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(0),[d,f]=(0,_.useState)([]),[p,m]=(0,_.useState)([]),h=(0,_.useRef)(0),g=(0,_.useRef)(0),v=(0,_.useRef)(!1),b=(0,_.useRef)(!1),x=(0,_.useRef)(!1),S=(0,_.useRef)(null),C=(0,_.useRef)(null),w=(0,_.useRef)(null);function T(e,t){let n=Array(t).fill(0),r=Array(t).fill(!1);for(let i=0;i<t;i++){let t=1+i*2,a=2+i*2;e>=t&&(r[i]=!0),e>=a?n[i]=1:e>=t&&(n[i]=0)}return{newProg:n,newVis:r}}function E(e,t,n){if(b.current)return;b.current=!0;let r=g.current===0?0:Math.ceil(g.current/2),i=e===0?0:Math.ceil(e/2);if(i!==r){let e=r*window.innerWidth,t=i*window.innerWidth,a=performance.now();(function r(i){let o=Math.min(1,(i-a)/500),s=e+(t-e)*Wu(o);if(w.current&&(w.current.style.transform=`translateX(-${s}px)`),o<1){requestAnimationFrame(r);return}w.current&&(w.current.style.transform=`translateX(-${t}px)`),b.current=!1,n?.()})(performance.now())}else b.current=!1,n?.()}function D(e,t){let n=Yu[e].oeuvres.length,r=t??0;h.current=e,g.current=r;let{newProg:a,newVis:s}=T(r,n);i(e),u(r),f(a),m(s),o(!1),c(!0),r===0&&requestAnimationFrame(()=>{requestAnimationFrame(()=>o(!0))})}function O(){if(v.current)return;v.current=!0;let t=h.current,n=Yu[t].oeuvres.length,r=t>=Yu.length-1,i=n*window.innerWidth,a=performance.now();(function n(o){let s=Math.min(1,(o-a)/600),c=i*(1-Wu(s));if(w.current&&(w.current.style.transform=`translateX(-${c}px)`),s<1){requestAnimationFrame(n);return}if(w.current&&(w.current.style.transform=`translateX(0)`),r){v.current=!1,x.current=!1,setTimeout(()=>{e?.current&&e.current.scrollIntoView({behavior:`smooth`})},50);return}let l=performance.now(),u=C.current;(function e(n){let r=Math.min(1,(n-l)/350),i=Gu(r)*100;if(u&&(u.style.transform=`translateY(-${i}svh)`),r<1){requestAnimationFrame(e);return}u&&(u.style.transform=`translateY(0)`),D(t+1,0),v.current=!1})(performance.now())})(performance.now())}function ee(){if(v.current||h.current===0)return;v.current=!0;let e=h.current-1,t=Yu[e].oeuvres.length;h.current=e,g.current=t*2;let{newProg:n,newVis:r}=T(t*2,t);i(e),u(t*2),f(n),m(r),o(!1),w.current&&(w.current.style.transform=`translateX(-${t*window.innerWidth}px)`);let a=C.current;a&&(a.style.transform=`translateY(-100svh)`),requestAnimationFrame(()=>{let e=performance.now();(function n(r){let i=Math.min(1,(r-e)/350),s=(1-Gu(i))*100;if(a&&(a.style.transform=`translateY(-${s}svh)`),i<1){requestAnimationFrame(n);return}a&&(a.style.transform=`translateY(0)`);let l=t*window.innerWidth,d=performance.now();(function e(n){let r=Math.min(1,(n-d)/700),i=l*(1-Wu(r));if(w.current&&(w.current.style.transform=`translateX(-${i}px)`),r<1){requestAnimationFrame(e);return}w.current&&(w.current.style.transform=`translateX(0)`),g.current=0,u(0),f(Array(t).fill(0)),m(Array(t).fill(!1)),o(!1),c(!0),requestAnimationFrame(()=>requestAnimationFrame(()=>o(!0))),v.current=!1})(performance.now())})(performance.now())})}function k(){if(v.current||b.current)return;let e=Yu[h.current].oeuvres.length,t=e*2,n=g.current+1;if(n>t){O();return}E(n,e,()=>{g.current=n,u(n);let{newProg:t,newVis:r}=T(n,e);f(t),m(r),n>0&&o(!1)})}function A(){if(v.current||b.current)return;let e=Yu[h.current].oeuvres.length,t=g.current-1;if(t<0){ee();return}E(t,e,()=>{g.current=t,u(t);let{newProg:n,newVis:r}=T(t,e);f(n),m(r),t===0&&(o(!1),c(!0),requestAnimationFrame(()=>requestAnimationFrame(()=>o(!0))))})}let j=(0,_.useCallback)(e=>{Math.abs(e)<.005||(e>0?k():A())},[]);function M(e,t){if(v.current)return;Yu[e].oeuvres.length;let n=1+t*2;if(D(e,n),w.current){let e=Math.ceil(n/2);w.current.style.transform=`translateX(-${e*window.innerWidth}px)`}S.current&&S.current.scrollIntoView({behavior:`smooth`})}(0,_.useEffect)(()=>{t?.(M)},[]);function te(){let e=S.current?.parentElement;if(!e)return;let t=e.offsetTop;window.scrollTo(0,t),window.__eraRailSetLockedY&&window.__eraRailSetLockedY(t),x.current=!0;let n=Yu.length-1,r=Yu[n].oeuvres.length;D(n,r*2),w.current&&(w.current.style.transform=`translateX(-${r*window.innerWidth}px)`)}(0,_.useEffect)(()=>{n?.(te)},[]),(0,_.useEffect)(()=>(window.__eraRailDeactivate=()=>{x.current=!1},()=>{delete window.__eraRailDeactivate}),[]),(0,_.useEffect)(()=>{let e=null,t=S.current?.parentElement?.offsetTop??0;function n(){x.current&&(window.__rollerDragging||window.scrollTo(0,t))}function r(n){if(!x.current)return;n.preventDefault(),n.stopPropagation();let r=n.deltaY;if(n.deltaMode===1&&(r*=24),n.deltaMode===2&&(r*=window.innerHeight),!e&&!(Math.abs(r)<10)){if(h.current===0&&g.current===0&&r<0){x.current=!1,window.scrollTo({top:t-window.innerHeight,behavior:`smooth`}),e=setTimeout(()=>{e=null},1e3);return}j(r),e=setTimeout(()=>{e=null},600)}}let i=0,a=0;function o(e){x.current&&(i=e.touches[0].clientY,a=0)}function s(e){if(!x.current)return;e.preventDefault();let t=i-e.touches[0].clientY;i=e.touches[0].clientY,a+=t,Math.abs(a)>50&&(j(a),a=0)}return window.addEventListener(`scroll`,n,{passive:!1}),window.addEventListener(`wheel`,r,{passive:!1}),window.addEventListener(`touchstart`,o,{passive:!0}),window.addEventListener(`touchmove`,s,{passive:!1}),window.__eraRailSetLockedY=e=>{t=e},()=>{window.removeEventListener(`scroll`,n),window.removeEventListener(`wheel`,r),window.removeEventListener(`touchstart`,o),window.removeEventListener(`touchmove`,s),delete window.__eraRailSetLockedY}},[j]),(0,_.useEffect)(()=>{let e=S.current?.parentElement;if(!e)return;let t=new IntersectionObserver(([e])=>{if(e.isIntersecting){let t=e.target.offsetTop;window.scrollTo(0,t),window.__eraRailSetLockedY&&window.__eraRailSetLockedY(t),window.__eraRailActive&&window.__eraRailActive(),x.current=!0}else x.current=!1},{threshold:.5});return t.observe(e),()=>t.disconnect()},[]),(0,_.useEffect)(()=>{D(0,0)},[]);let N=Yu[r],P=N.DatePanel;return(0,y.jsx)(`div`,{className:`s-horizontal-rail`,style:{height:`100svh`,position:`relative`},children:(0,y.jsx)(`div`,{ref:S,className:`s-horizontal-sticky`,style:{position:`sticky`,top:0,height:`100svh`,overflow:`hidden`},children:(0,y.jsx)(`div`,{style:{position:`absolute`,inset:0,overflow:`hidden`},children:(0,y.jsxs)(`div`,{ref:C,style:{position:`absolute`,top:0,left:0,right:0,height:`200svh`,willChange:`transform`},children:[(0,y.jsx)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:`100svh`,overflow:`hidden`},children:(0,y.jsxs)(`div`,{ref:w,style:{display:`flex`,height:`100%`,willChange:`transform`,width:`${(N.oeuvres.length+1)*100}vw`},children:[(0,y.jsx)(`div`,{className:`h-panel`,children:(0,y.jsx)(P,{animated:a,zoomOut:s})}),N.oeuvres.map(({Component:e},t)=>(0,y.jsx)(`div`,{className:`h-panel`,children:(0,y.jsx)(e,{progress:d[t]??0,canStart:p[t]??!1,autoMode:!1})},`${r}-${t}`))]})}),(0,y.jsx)(`div`,{style:{position:`absolute`,top:`100svh`,left:0,right:0,height:`100svh`,overflow:`hidden`,visibility:`hidden`}})]})})})})}function Zu({toggleLangExternal:e}){let{toggleLang:t}=C(),n=e??t,[r,i]=(0,_.useState)(!1),a=qu(),o=(0,_.useRef)(null),s=(0,_.useRef)(null),c=(0,_.useRef)(null),l=(0,_.useRef)(null),u=(0,_.useRef)(null),d=(0,_.useRef)(null),f=(0,_.useRef)(!1),p=(0,_.useRef)([]);function m(e){if(f.current)return;let t=p.current;t[t.length-1]!==e&&t.push(e)}function h(){let e=p.current;if(e.length<2)return;e.pop();let t=e[e.length-1];f.current=!0,setTimeout(()=>{f.current=!1},1400),window.__eraRailDeactivate?.(),t===`accueil`?setTimeout(()=>o.current?.scrollIntoView({behavior:`smooth`}),50):t===`machine`?setTimeout(()=>s.current?.scrollIntoView({behavior:`smooth`}),50):t===`livre`?setTimeout(()=>c.current?.scrollIntoView({behavior:`smooth`}),50):t===`era`?d.current?.():t===`footer`&&setTimeout(()=>l.current?.scrollIntoView({behavior:`smooth`}),50)}return(0,_.useEffect)(()=>{let e=[{ref:o,name:`accueil`},{ref:s,name:`machine`},{ref:c,name:`livre`},{ref:l,name:`footer`}].map(({ref:e,name:t})=>{let n=e.current;if(!n)return null;let r=new IntersectionObserver(([e])=>{e.isIntersecting&&m(t)},{threshold:.5});return r.observe(n),r});return window.__eraRailActive=()=>m(`era`),()=>{e.forEach(e=>e?.disconnect()),delete window.__eraRailActive}},[]),Ju(o,a),Ju(s,a),(0,_.useEffect)(()=>{`scrollRestoration`in history&&(history.scrollRestoration=`manual`),window.scrollTo(0,0)},[]),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`div`,{ref:o,children:(0,y.jsx)(A,{canStart:r})}),(0,y.jsx)(`div`,{ref:s,children:(0,y.jsx)(Cl,{})}),(0,y.jsx)(`div`,{ref:c,children:(0,y.jsx)(Dl,{})}),(0,y.jsx)(Xu,{nextSectionRef:l,onRegisterJump:e=>{u.current=e},onRegisterReactivate:e=>{d.current=e}}),(0,y.jsx)(`div`,{ref:l,children:(0,y.jsx)(Ml,{onScrollBack:()=>d.current?.()})}),(0,y.jsx)(`div`,{id:`keyboard-fixed`,children:(0,y.jsx)(zl,{navigateTo:(e,t)=>{e===`machine`?(window.__eraRailDeactivate?.(),setTimeout(()=>s.current?.scrollIntoView({behavior:`smooth`}),50)):e===`toggleLang`?n():e===`__back__`?h():u.current?.(e,t)}})}),(0,y.jsx)(Nl,{}),(0,y.jsx)(Vl,{}),!r&&(0,y.jsx)(D,{onFinish:()=>i(!0)})]})}function Qu(){let[e,t]=(0,_.useState)(`fr`),n=()=>t(e=>e===`fr`?`en`:`fr`);return(0,y.jsx)(S,{lang:e,toggleLang:n,children:(0,y.jsx)(Zu,{toggleLangExternal:n},e)})}(0,g.createRoot)(document.getElementById(`root`)).render((0,y.jsx)(_.StrictMode,{children:(0,y.jsx)(Qu,{})}));