...
88888888
88888888
`;function Bu({animated:e,zoomOut:t,children:n}){let r=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let n=r.current;if(!n)return;if(!e){n.style.animation=`none`,n.style.opacity=`0`;return}n.style.animation=`none`,n.style.opacity=`0`,n.offsetWidth;let i=t?`dateZoomOut 0.9s cubic-bezier(0.25,0.46,0.45,0.94) both`:`dateZoomIn 0.65s cubic-bezier(0.34,1.56,0.64,1) both`;n.style.animation=i,n.style.opacity=``},[e,t]),(0,y.jsx)(`div`,{className:`era-date-panel`,children:(0,y.jsx)(`div`,{ref:r,className:`date-stack`,style:{opacity:0},children:n})})}function Vu({animated:e,zoomOut:t}){return(0,y.jsxs)(Bu,{animated:e,zoomOut:t,children:[(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Mu}),(0,y.jsx)(`pre`,{className:`date-ascii-dash`,children:zu}),(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Nu})]})}function Hu({animated:e,zoomOut:t}){return(0,y.jsxs)(Bu,{animated:e,zoomOut:t,children:[(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Pu}),(0,y.jsx)(`pre`,{className:`date-ascii-dash`,children:zu}),(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Fu})]})}function Uu({animated:e,zoomOut:t}){return(0,y.jsx)(Bu,{animated:e,zoomOut:t,children:(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Iu})})}function Wu({animated:e,zoomOut:t}){return(0,y.jsxs)(Bu,{animated:e,zoomOut:t,children:[(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Lu}),(0,y.jsx)(`pre`,{className:`date-ascii-dash`,children:zu}),(0,y.jsx)(`pre`,{className:`date-ascii-line`,children:Ru})]})}function Gu(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}function Ku(e){return 1-(1-e)**3}var qu=2e3;function Ju(){let e=(0,_.useRef)(!1),t=(0,_.useRef)(0);function n(){if(e.current)return;e.current=!0,t.current=window.scrollY;function n(){window.scrollTo(0,t.current)}window.addEventListener(`scroll`,n,{passive:!1}),setTimeout(()=>{window.removeEventListener(`scroll`,n),e.current=!1},qu)}return n}function Yu(e,t){let n=(0,_.useRef)(!1);(0,_.useEffect)(()=>{let r=e.current;if(!r)return;let i=new IntersectionObserver(([e])=>{e.isIntersecting&&!n.current&&(n.current=!0,t())},{threshold:1});return i.observe(r),()=>i.disconnect()},[])}var Xu=[{DatePanel:Vu,oeuvres:[{Component:ku},{Component:Au},{Component:ju},{Component:_u}]},{DatePanel:Hu,oeuvres:[{Component:vu},{Component:yu},{Component:bu},{Component:xu},{Component:Su},{Component:Cu}]},{DatePanel:Uu,oeuvres:[{Component:wu}]},{DatePanel:Wu,oeuvres:[{Component:Tu},{Component:Eu},{Component:Du},{Component:Ou}]}];function Zu({nextSectionRef:e,onRegisterJump:t,onRegisterReactivate:n}){let[r,i]=(0,_.useState)(0),[a,o]=(0,_.useState)(!1),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(0),[d,f]=(0,_.useState)([]),[p,m]=(0,_.useState)([]),h=(0,_.useRef)(0),g=(0,_.useRef)(0),v=(0,_.useRef)(!1),b=(0,_.useRef)(!1),x=(0,_.useRef)(!1),S=(0,_.useRef)(null),C=(0,_.useRef)(null),w=(0,_.useRef)(null);function T(e,t){let n=Array(t).fill(0),r=Array(t).fill(!1);for(let i=0;i<t;i++){let t=1+i*2,a=2+i*2;e>=t&&(r[i]=!0),e>=a?n[i]=1:e>=t&&(n[i]=0)}return{newProg:n,newVis:r}}function E(e,t,n){if(b.current)return;b.current=!0;let r=g.current===0?0:Math.ceil(g.current/2),i=e===0?0:Math.ceil(e/2);if(i!==r){let e=r*window.innerWidth,t=i*window.innerWidth,a=performance.now();(function r(i){let o=Math.min(1,(i-a)/500),s=e+(t-e)*Gu(o);if(w.current&&(w.current.style.transform=`translateX(-${s}px)`),o<1){requestAnimationFrame(r);return}w.current&&(w.current.style.transform=`translateX(-${t}px)`),b.current=!1,n?.()})(performance.now())}else b.current=!1,n?.()}function D(e,t){let n=Xu[e].oeuvres.length,r=t??0;h.current=e,g.current=r;let{newProg:a,newVis:s}=T(r,n);i(e),u(r),f(a),m(s),o(!1),c(!0),r===0&&requestAnimationFrame(()=>{requestAnimationFrame(()=>o(!0))})}function O(){if(v.current)return;v.current=!0;let t=h.current,n=Xu[t].oeuvres.length,r=t>=Xu.length-1,i=n*window.innerWidth,a=performance.now();(function n(o){let s=Math.min(1,(o-a)/600),c=i*(1-Gu(s));if(w.current&&(w.current.style.transform=`translateX(-${c}px)`),s<1){requestAnimationFrame(n);return}if(w.current&&(w.current.style.transform=`translateX(0)`),r){v.current=!1,x.current=!1,e?.current&&e.current.scrollIntoView({behavior:`smooth`});return}let l=performance.now(),u=C.current;(function e(n){let r=Math.min(1,(n-l)/350),i=Ku(r)*100;if(u&&(u.style.transform=`translateY(-${i}svh)`),r<1){requestAnimationFrame(e);return}u&&(u.style.transform=`translateY(0)`),D(t+1,0),v.current=!1})(performance.now())})(performance.now())}function ee(){if(v.current||h.current===0)return;v.current=!0;let e=h.current-1,t=Xu[e].oeuvres.length;h.current=e,g.current=t*2;let{newProg:n,newVis:r}=T(t*2,t);i(e),u(t*2),f(n),m(r),o(!1),w.current&&(w.current.style.transform=`translateX(-${t*window.innerWidth}px)`);let a=C.current;a&&(a.style.transform=`translateY(-100svh)`),requestAnimationFrame(()=>{let e=performance.now();(function n(r){let i=Math.min(1,(r-e)/350),s=(1-Ku(i))*100;if(a&&(a.style.transform=`translateY(-${s}svh)`),i<1){requestAnimationFrame(n);return}a&&(a.style.transform=`translateY(0)`);let l=t*window.innerWidth,d=performance.now();(function e(n){let r=Math.min(1,(n-d)/700),i=l*(1-Gu(r));if(w.current&&(w.current.style.transform=`translateX(-${i}px)`),r<1){requestAnimationFrame(e);return}w.current&&(w.current.style.transform=`translateX(0)`),g.current=0,u(0),f(Array(t).fill(0)),m(Array(t).fill(!1)),o(!1),c(!0),requestAnimationFrame(()=>requestAnimationFrame(()=>o(!0))),v.current=!1})(performance.now())})(performance.now())})}function k(){if(v.current||b.current)return;let e=Xu[h.current].oeuvres.length,t=e*2,n=g.current+1;if(n>t){O();return}E(n,e,()=>{g.current=n,u(n);let{newProg:t,newVis:r}=T(n,e);f(t),m(r),n>0&&o(!1)})}function A(){if(v.current||b.current)return;let e=Xu[h.current].oeuvres.length,t=g.current-1;if(t<0){ee();return}E(t,e,()=>{g.current=t,u(t);let{newProg:n,newVis:r}=T(t,e);f(n),m(r),t===0&&(o(!1),c(!0),requestAnimationFrame(()=>requestAnimationFrame(()=>o(!0))))})}let j=(0,_.useCallback)(e=>{Math.abs(e)<.005||(e>0?k():A())},[]);function M(e,t){if(v.current)return;Xu[e].oeuvres.length;let n=1+t*2;if(D(e,n),w.current){let e=Math.ceil(n/2);w.current.style.transform=`translateX(-${e*window.innerWidth}px)`}S.current&&S.current.scrollIntoView({behavior:`smooth`})}(0,_.useEffect)(()=>{t?.(M)},[]);function te(){let e=S.current?.parentElement;if(!e)return;let t=e.offsetTop;window.scrollTo(0,t),window.__eraRailSetLockedY&&window.__eraRailSetLockedY(t),x.current=!0;let n=Xu.length-1,r=Xu[n].oeuvres.length;D(n,r*2),w.current&&(w.current.style.transform=`translateX(-${r*window.innerWidth}px)`)}(0,_.useEffect)(()=>{n?.(te)},[]),(0,_.useEffect)(()=>{let e=null,t=0;function n(){x.current&&window.scrollTo(0,t)}function r(n){if(!x.current)return;n.preventDefault(),n.stopPropagation();let r=n.deltaY;if(n.deltaMode===1&&(r*=24),n.deltaMode===2&&(r*=window.innerHeight),!e&&!(Math.abs(r)<10)){if(h.current===0&&g.current===0&&r<0){x.current=!1,window.scrollTo({top:t-window.innerHeight,behavior:`smooth`}),e=setTimeout(()=>{e=null},1e3);return}j(r),e=setTimeout(()=>{e=null},600)}}let i=0,a=0;function o(e){x.current&&(i=e.touches[0].clientY,a=0)}function s(e){if(!x.current)return;e.preventDefault();let t=i-e.touches[0].clientY;i=e.touches[0].clientY,a+=t,Math.abs(a)>50&&(j(a),a=0)}return window.addEventListener(`scroll`,n,{passive:!1}),window.addEventListener(`wheel`,r,{passive:!1}),window.addEventListener(`touchstart`,o,{passive:!0}),window.addEventListener(`touchmove`,s,{passive:!1}),window.__eraRailSetLockedY=e=>{t=e},()=>{window.removeEventListener(`scroll`,n),window.removeEventListener(`wheel`,r),window.removeEventListener(`touchstart`,o),window.removeEventListener(`touchmove`,s),delete window.__eraRailSetLockedY}},[j]),(0,_.useEffect)(()=>{let e=S.current?.parentElement;if(!e)return;let t=new IntersectionObserver(([e])=>{if(e.isIntersecting){let t=e.target.offsetTop;window.scrollTo(0,t),window.__eraRailSetLockedY&&window.__eraRailSetLockedY(t),window.__eraRailActive&&window.__eraRailActive(),x.current=!0}else x.current=!1},{threshold:.5});return t.observe(e),()=>t.disconnect()},[]),(0,_.useEffect)(()=>{D(0,0)},[]);let N=Xu[r],P=N.DatePanel;return(0,y.jsx)(`div`,{className:`s-horizontal-rail`,style:{height:`100svh`,position:`relative`},children:(0,y.jsxs)(`div`,{ref:S,className:`s-horizontal-sticky`,style:{position:`sticky`,top:0,height:`100svh`,overflow:`hidden`},children:[(0,y.jsx)(`div`,{style:{position:`absolute`,inset:0,overflow:`hidden`},children:(0,y.jsxs)(`div`,{ref:C,style:{position:`absolute`,top:0,left:0,right:0,height:`200svh`,willChange:`transform`},children:[(0,y.jsx)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,height:`100svh`,overflow:`hidden`},children:(0,y.jsxs)(`div`,{ref:w,style:{display:`flex`,height:`100%`,willChange:`transform`,width:`${(N.oeuvres.length+1)*100}vw`},children:[(0,y.jsx)(`div`,{className:`h-panel`,children:(0,y.jsx)(P,{animated:a,zoomOut:s})}),N.oeuvres.map(({Component:e},t)=>(0,y.jsx)(`div`,{className:`h-panel`,children:(0,y.jsx)(e,{progress:d[t]??0,canStart:p[t]??!1,autoMode:!1})},`${r}-${t}`))]})}),(0,y.jsx)(`div`,{style:{position:`absolute`,top:`100svh`,left:0,right:0,height:`100svh`,overflow:`hidden`,visibility:`hidden`}})]})}),` `]})})}function Qu({toggleLangExternal:e}){let{toggleLang:t}=C(),n=e??t,[r,i]=(0,_.useState)(!1),a=Ju(),o=(0,_.useRef)(null),s=(0,_.useRef)(null),c=(0,_.useRef)(null),l=(0,_.useRef)(null),u=(0,_.useRef)(null),d=(0,_.useRef)(null),f=(0,_.useRef)([]);function p(e){let t=f.current;t[t.length-1]!==e&&t.push(e)}function m(){let e=f.current;if(e.length<2)return;e.pop();let t=e[e.length-1];t===`accueil`?o.current?.scrollIntoView({behavior:`smooth`}):t===`machine`?s.current?.scrollIntoView({behavior:`smooth`}):t===`livre`?c.current?.scrollIntoView({behavior:`smooth`}):t===`era`?d.current?.():t===`footer`&&l.current?.scrollIntoView({behavior:`smooth`})}return(0,_.useEffect)(()=>{let e=[{ref:o,name:`accueil`},{ref:s,name:`machine`},{ref:c,name:`livre`},{ref:l,name:`footer`}].map(({ref:e,name:t})=>{let n=e.current;if(!n)return null;let r=new IntersectionObserver(([e])=>{e.isIntersecting&&p(t)},{threshold:.5});return r.observe(n),r});return window.__eraRailActive=()=>p(`era`),()=>{e.forEach(e=>e?.disconnect()),delete window.__eraRailActive}},[]),Yu(o,a),Yu(s,a),(0,_.useEffect)(()=>{`scrollRestoration`in history&&(history.scrollRestoration=`manual`),window.scrollTo(0,0)},[]),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`div`,{ref:o,children:(0,y.jsx)(A,{canStart:r})}),(0,y.jsx)(`div`,{ref:s,children:(0,y.jsx)(wl,{})}),(0,y.jsx)(`div`,{ref:c,children:(0,y.jsx)(Ol,{})}),(0,y.jsx)(Zu,{nextSectionRef:l,onRegisterJump:e=>{u.current=e},onRegisterReactivate:e=>{d.current=e}}),(0,y.jsx)(`div`,{ref:l,children:(0,y.jsx)(Nl,{onScrollBack:()=>d.current?.()})}),(0,y.jsx)(`div`,{id:`keyboard-fixed`,children:(0,y.jsx)(Bl,{navigateTo:(e,t)=>{e===`machine`?s.current?.scrollIntoView({behavior:`smooth`}):e===`toggleLang`?n():e===`__back__`?m():u.current?.(e,t)}})}),(0,y.jsx)(Pl,{}),(0,y.jsx)(Hl,{}),!r&&(0,y.jsx)(D,{onFinish:()=>i(!0)})]})}function $u(){let[e,t]=(0,_.useState)(`fr`),n=()=>t(e=>e===`fr`?`en`:`fr`);return(0,y.jsx)(S,{lang:e,toggleLang:n,children:(0,y.jsx)(Qu,{toggleLangExternal:n},e)})}(0,g.createRoot)(document.getElementById(`root`)).render((0,y.jsx)(_.StrictMode,{children:(0,y.jsx)($u,{})}));